...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000008, 0xFFFFFF68, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000000, 0x000012D4, 0x000005E0, xiaomi_do_pdaf},
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT chagall5kkdsfront_mtk_eeprom_ofilm = {
	.name = "chagall5kkdsfront_mtk_eeprom_ofilm",

...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000008, 0xff7f52a2, CAM_CAL_SINGLE_EEPROM_DATA,
	{
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT chagallovx8000wide_mtk_eeprom_sunny = {
	.name = "chagallovx8000wide_mtk_eeprom_sunny",

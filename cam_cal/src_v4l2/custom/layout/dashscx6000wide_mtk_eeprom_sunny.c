...
unsigned int dashscx6000wide_sunny_do_pdaf(struct EEPROM_DRV_FD_DATA *pdata,
	unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);

static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000008, 0xFF8048A4, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000001, 0x000012D6, 0x00000A28, dashscx6000wide_sunny_do_pdaf},
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT dashscx6000wide_mtk_eeprom_sunny = {
	.name = "dashscx6000wide_mtk_eeprom_sunny",
	...
	unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData)
{
	...
	read_data_size = read_data(pdata, pCamCalData->sensorID, pCamCalData->deviceID,
								0x18BD, 496, (unsigned char *)&pCamCalData->PDAF.Data[1500]);
	pCamCalData->PDAF.Size_of_PDAF = 1996;
	read_data(pdata, pCamCalData->sensorID, pCamCalData->deviceID,
					0x1AAF, 1004, (u8 *)&pCamCalData->PDAF.Data[1996]);

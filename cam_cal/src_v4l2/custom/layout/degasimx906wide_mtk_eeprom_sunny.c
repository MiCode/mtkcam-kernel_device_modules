...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000008, 0xFF54CDED, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000001, 0x0000107A, 0x00001004, xiaomi_do_pdaf},
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT degasimx906wide_mtk_eeprom_sunny = {
	.name = "degasimx906wide_mtk_eeprom_sunny",

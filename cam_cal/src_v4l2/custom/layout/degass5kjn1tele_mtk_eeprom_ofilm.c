...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000008, 0xFF51D638, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000001, 0x000012D6, 0x000005DD, xiaomi_do_pdaf},
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT degass5kjn1tele_mtk_eeprom_ofilm = {
	.name = "degass5kjn1tele_mtk_eeprom_ofilm",

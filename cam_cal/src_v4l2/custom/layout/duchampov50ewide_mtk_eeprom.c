...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000008, 0xFF4DB920, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000001, 0x00001A96, 0x00000A2A, xiaomi_do_pdaf},
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT duchampov50ewide_mtk_eeprom = {
	.name = "duchampov50ewide_mtk_eeprom",

...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000008, 0xFF3CA1DC, CAM_CAL_SINGLE_EEPROM_DATA,
	{
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT duchampov64b40wide_mtk_eeprom_aac = {
	.name = "duchampov64b40wide_mtk_eeprom_aac",

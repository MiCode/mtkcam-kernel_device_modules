...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000008, 0xFFFFFF9B, CAM_CAL_SINGLE_EEPROM_DATA,
	{
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT malachiteimx355ultra_mtk_eeprom_ofilm = {
	.name = "malachiteimx355ultra_mtk_eeprom_ofilm",

...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000008, 0xFF4DC830, CAM_CAL_SINGLE_EEPROM_DATA,
	{
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT malachiteimx882wide_mtk_eeprom_aac = {
	.name = "malachiteimx882wide_mtk_eeprom_aac",

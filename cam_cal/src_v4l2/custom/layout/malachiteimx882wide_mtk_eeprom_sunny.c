...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000008, 0xFF59DA30, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000001, 0x00001E1D, 0x00001004, xiaomi_do_pdaf},
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT malachiteimx882wide_mtk_eeprom_sunny = {
	.name = "malachiteimx882wide_mtk_eeprom_sunny",

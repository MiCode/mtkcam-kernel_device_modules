...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000008, 0xFF59E313, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000001, 0x00001EE2, 0x000005DC, xiaomi_do_pdaf},
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT malachites5khp3wide_mtk_eeprom_sunny = {
	.name = "malachites5khp3wide_mtk_eeprom_sunny",

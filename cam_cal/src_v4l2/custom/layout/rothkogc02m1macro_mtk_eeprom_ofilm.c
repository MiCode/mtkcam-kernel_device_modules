...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000008, 0xFFFFFF1F, CAM_CAL_SINGLE_EEPROM_DATA,
	{
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT rothkogc02m1macro_mtk_eeprom_ofilm = {
	.name = "rothkogc02m1macro_mtk_eeprom_ofilm",

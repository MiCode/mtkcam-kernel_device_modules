...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000008, 0xFF54D420, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000001, 0x00001078, 0x00001004, xiaomi_do_pdaf},
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT rothkoimx906wide_mtk_eeprom_aac = {
	.name = "rothkoimx906wide_mtk_eeprom_aac",

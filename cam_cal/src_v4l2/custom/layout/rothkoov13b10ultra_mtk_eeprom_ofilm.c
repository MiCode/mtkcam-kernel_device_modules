...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000008, 0xFFFFFF1D, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000000, 0x00000EF1, 0x00001A35, xiaomi_do_pdaf},
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT rothkoov13b10ultra_mtk_eeprom_ofilm = {
	.name = "rothkoov13b10ultra_mtk_eeprom_ofilm",

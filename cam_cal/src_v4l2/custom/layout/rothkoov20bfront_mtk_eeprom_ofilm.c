...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000008, 0xFFFFFFA3, CAM_CAL_SINGLE_EEPROM_DATA,
	{
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT rothkoov20bfront_mtk_eeprom_ofilm = {
	.name = "rothkoov20bfront_mtk_eeprom_ofilm",

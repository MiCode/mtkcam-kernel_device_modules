...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000008, 0xFF4CD036, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000001, 0x00000EF1, 0x00001A35, xiaomi_do_pdaf},
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT rothkoov50hwide_mtk_eeprom_ofilm = {
	.name = "rothkoov50hwide_mtk_eeprom_ofilm",

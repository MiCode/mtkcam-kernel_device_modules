...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000008, 0xFF11D137, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000001, 0x0000136C, 0x000005DD, xiaomi_do_pdaf},
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT rothkos5kjn1tele_mtk_eeprom_sunny = {
	.name = "rothkos5kjn1tele_mtk_eeprom_sunny",

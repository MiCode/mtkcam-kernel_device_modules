...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000008, 0xFFFFFF35, CAM_CAL_SINGLE_EEPROM_DATA,
	{
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT rothkos5kkd1front_mtk_eeprom_sunny = {
	.name = "rothkos5kkd1front_mtk_eeprom_sunny",

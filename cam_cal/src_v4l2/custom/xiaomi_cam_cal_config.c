		...
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData)
{
...
#ifdef __XIAOMI_CAMERA__
	if (0x0800 == pCamCalData->sensorID || DALIOVX8000WIDE_SENSOR_ID == pCamCalData->sensorID || KLIMTOVX9100WIDE_SENSOR_ID == pCamCalData->sensorID) {
		read_data_size = read_data(pdata, pCamCalData->sensorID, pCamCalData->deviceID,
		...
		if(KLIMTS5KJN5TELE_SENSOR_ID == pCamCalData->sensorID || KLIMTS5KJN5TELE_V2_SENSOR_ID == pCamCalData->sensorID){
			read_data(pdata, pCamCalData->sensorID, pCamCalData->deviceID,
	...
	if(0x906 == pCamCalData->sensorID || RODINIMX882WIDE_SENSOR_ID == pCamCalData->sensorID){
		read_data_size = read_data(pdata, pCamCalData->sensorID, pCamCalData->deviceID,

	...
	struct sv_cq_th_setting *sv_cq_setting)
{
	...
	sv_th_setting[CAMSV_0].ultra_th = 1<<28|FIFO_THRESHOLD(3412, 0, 0);
	sv_th_setting[CAMSV_0].pultra_th = 1<<28|FIFO_THRESHOLD(3412, 0, 0);
	sv_th_setting[CAMSV_0].dvfs_th = 1<<31|FIFO_THRESHOLD(3412, 0, 0);
	sv_th_setting[CAMSV_0].urgent_th2 = 1<<31|FIFO_THRESHOLD(2132, 2/10, 1/10);
	sv_th_setting[CAMSV_0].ultra_th2 = 1<<28|FIFO_THRESHOLD(2132, 0, 0);
	sv_th_setting[CAMSV_0].pultra_th2 = 1<<28|FIFO_THRESHOLD(2132, 0, 0);
	sv_th_setting[CAMSV_0].dvfs_th2 = 1<<31|FIFO_THRESHOLD(2132, 0, 0);
	sv_th_setting[CAMSV_0].urgent_len1_th = 1<<31|FIFO_THRESHOLD(128, 2/10, 1/10);
	sv_th_setting[CAMSV_0].ultra_len1_th = 1<<28|FIFO_THRESHOLD(128, 0, 0);
	sv_th_setting[CAMSV_0].pultra_len1_th = 1<<28|FIFO_THRESHOLD(128, 0, 0);
	sv_th_setting[CAMSV_0].dvfs_len1_th = 1<<31|FIFO_THRESHOLD(128, 0, 0);
	sv_th_setting[CAMSV_0].urgent_len2_th = 1<<31|FIFO_THRESHOLD(64, 2/10, 1/10);
	sv_th_setting[CAMSV_0].ultra_len2_th = 1<<28|FIFO_THRESHOLD(64, 0, 0);
	sv_th_setting[CAMSV_0].pultra_len2_th = 1<<28|FIFO_THRESHOLD(64, 0, 0);
	sv_th_setting[CAMSV_0].dvfs_len2_th = 1<<31|FIFO_THRESHOLD(64, 0, 0);

	sv_th_setting[CAMSV_1].urgent_th = 1<<31|FIFO_THRESHOLD(3412, 2/10, 1/10);
	sv_th_setting[CAMSV_1].ultra_th = 1<<28|FIFO_THRESHOLD(3412, 0, 0);
	sv_th_setting[CAMSV_1].pultra_th = 1<<28|FIFO_THRESHOLD(3412, 0, 0);
	sv_th_setting[CAMSV_1].dvfs_th = 1<<31|FIFO_THRESHOLD(3412, 0, 0);
	sv_th_setting[CAMSV_1].urgent_th2 = 1<<31|FIFO_THRESHOLD(2132, 2/10, 1/10);
	sv_th_setting[CAMSV_1].ultra_th2 = 1<<28|FIFO_THRESHOLD(2132, 0, 0);
	sv_th_setting[CAMSV_1].pultra_th2 = 1<<28|FIFO_THRESHOLD(2132, 0, 0);
	sv_th_setting[CAMSV_1].dvfs_th2 = 1<<31|FIFO_THRESHOLD(2132, 0, 0);
	sv_th_setting[CAMSV_1].urgent_len1_th = 1<<31|FIFO_THRESHOLD(128, 2/10, 1/10);
	sv_th_setting[CAMSV_1].ultra_len1_th = 1<<28|FIFO_THRESHOLD(128, 0, 0);
	sv_th_setting[CAMSV_1].pultra_len1_th = 1<<28|FIFO_THRESHOLD(128, 0, 0);
	sv_th_setting[CAMSV_1].dvfs_len1_th = 1<<31|FIFO_THRESHOLD(128, 0, 0);
	sv_th_setting[CAMSV_1].urgent_len2_th = 1<<31|FIFO_THRESHOLD(64, 2/10, 1/10);
	sv_th_setting[CAMSV_1].ultra_len2_th = 1<<28|FIFO_THRESHOLD(64, 0, 0);
	sv_th_setting[CAMSV_1].pultra_len2_th = 1<<28|FIFO_THRESHOLD(64, 0, 0);
	sv_th_setting[CAMSV_1].dvfs_len2_th = 1<<31|FIFO_THRESHOLD(64, 0, 0);

	sv_th_setting[CAMSV_2].urgent_th = 1<<31|FIFO_THRESHOLD(2560, 2/10, 1/10);
	sv_th_setting[CAMSV_2].ultra_th = 1<<28|FIFO_THRESHOLD(2560, 0, 0);
	sv_th_setting[CAMSV_2].pultra_th = 1<<28|FIFO_THRESHOLD(2560, 0, 0);
	sv_th_setting[CAMSV_2].dvfs_th = 1<<31|FIFO_THRESHOLD(2560, 0, 0);
	sv_th_setting[CAMSV_2].urgent_len1_th = 1<<31|FIFO_THRESHOLD(128, 2/10, 1/10);
	sv_th_setting[CAMSV_2].ultra_len1_th = 1<<28|FIFO_THRESHOLD(128, 0, 0);
	sv_th_setting[CAMSV_2].pultra_len1_th = 1<<28|FIFO_THRESHOLD(128, 0, 0);
	sv_th_setting[CAMSV_2].dvfs_len1_th = 1<<31|FIFO_THRESHOLD(128, 0, 0);

	sv_th_setting[CAMSV_3].urgent_th = 1<<31|FIFO_THRESHOLD(1600, 2/10, 1/10);
	sv_th_setting[CAMSV_3].ultra_th = 1<<28|FIFO_THRESHOLD(1600, 0, 0);
	sv_th_setting[CAMSV_3].pultra_th = 1<<28|FIFO_THRESHOLD(1600, 0, 0);
	sv_th_setting[CAMSV_3].dvfs_th = 1<<31|FIFO_THRESHOLD(1600, 0, 0);
	sv_th_setting[CAMSV_3].urgent_len1_th = 1<<31|FIFO_THRESHOLD(64, 2/10, 1/10);
	sv_th_setting[CAMSV_3].ultra_len1_th = 1<<28|FIFO_THRESHOLD(64, 0, 0);
	sv_th_setting[CAMSV_3].pultra_len1_th = 1<<28|FIFO_THRESHOLD(64, 0, 0);
	sv_th_setting[CAMSV_3].dvfs_len1_th = 1<<31|FIFO_THRESHOLD(64, 0, 0);

	sv_th_setting[CAMSV_4].urgent_th = 1<<31|FIFO_THRESHOLD(440, 2/10, 1/10);
	sv_th_setting[CAMSV_4].ultra_th = 1<<28|FIFO_THRESHOLD(440, 0, 0);
	sv_th_setting[CAMSV_4].pultra_th = 1<<28|FIFO_THRESHOLD(440, 0, 0);
	sv_th_setting[CAMSV_4].dvfs_th = 1<<31|FIFO_THRESHOLD(440, 0, 0);

	sv_th_setting[CAMSV_5].urgent_th = 1<<31|FIFO_THRESHOLD(440, 2/10, 1/10);
	sv_th_setting[CAMSV_5].ultra_th = 1<<28|FIFO_THRESHOLD(440, 0, 0);
	sv_th_setting[CAMSV_5].pultra_th = 1<<28|FIFO_THRESHOLD(440,0, 0);
	sv_th_setting[CAMSV_5].dvfs_th = 1<<31|FIFO_THRESHOLD(440, 0, 0);

	sv_cq_setting->cq1_fifo_size = (0x10 << 24) | 64;
	sv_cq_setting->cq1_urgent_th = 1<<31|FIFO_THRESHOLD(64, 2/10, 1/10);
	sv_cq_setting->cq1_ultra_th = 1<<28|FIFO_THRESHOLD(64, 0, 0);
	sv_cq_setting->cq1_pultra_th = 1<<28|FIFO_THRESHOLD(64, 0, 0);
	sv_cq_setting->cq1_dvfs_th = 1<<31|FIFO_THRESHOLD(64, 0, 0);

	sv_cq_setting->cq2_fifo_size = (0x10 << 24) | 64;
	sv_cq_setting->cq2_urgent_th = 1<<31|FIFO_THRESHOLD(64, 2/10, 1/10);
	sv_cq_setting->cq2_ultra_th = 1<<28|FIFO_THRESHOLD(64, 0, 0);
	sv_cq_setting->cq2_pultra_th = 1<<28|FIFO_THRESHOLD(64, 0, 0);
	sv_cq_setting->cq2_dvfs_th = 1<<31|FIFO_THRESHOLD(64, 0, 0);
	return 0;
}

...
#define RG_PRBS_CHK_EN_MASK (0x1 << 0)
#define RG_PRBS_CHK_MODE_SHIFT 1
#define RG_PRBS_CHK_MODE_MASK (0x1 << 1)
#define RO_PRBS_CHK_DONE_SHIFT 4
#define RO_PRBS_CHK_DONE_MASK (0x1 << 4)
#define RO_PRBS_CHK_FAIL_SHIFT 5
#define RO_PRBS_CHK_FAIL_MASK (0x1 << 5)

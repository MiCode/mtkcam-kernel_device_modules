 ...
 * Filename:
 * ---------
 *	 chagalls5kjn5telemipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
 ...
 *============================================================================
 ****************************************************************************/
#include "chagalls5kjn5telemipiraw_Sensor.h"

static int get_sensor_temperature(void *arg);
static void set_group_hold(void *arg, u8 en);
static int chagalls5kjn5tele_set_max_framerate_by_scenario(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static u16 get_gain2reg(u32 gain);
static int chagalls5kjn5tele_get_imgsensor_id(struct subdrv_ctx *ctx, u32 *sensor_id);
static int chagalls5kjn5tele_control(struct subdrv_ctx *ctx, enum MSDK_SCENARIO_ID_ENUM scenario_id,
		MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
		MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data);
static int chagalls5kjn5tele_set_test_pattern(struct subdrv_ctx *ctx, u8 *para, u32 *len);
...
static int chagalls5kjn5tele_seamless_switch(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int chagalls5kjn5tele_set_multi_shutter_frame_length(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int chagalls5kjn5tele_set_gain(struct subdrv_ctx *ctx, u8 *para, u32 *len);
void chagalls5kjn5tele_set_long_exposure(struct subdrv_ctx *ctx);
void chagalls5kjn5tele_write_frame_length(struct subdrv_ctx *ctx, u32 fll);
static int chagalls5kjn5tele_set_shutter_frame_length(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int chagalls5kjn5tele_set_shutter(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int chagalls5kjn5tele_set_awb_gain(struct subdrv_ctx *ctx, u8 *para, u32 *len);
...
static struct subdrv_feature_control feature_control_list[] = {
	{SENSOR_FEATURE_SET_TEST_PATTERN, chagalls5kjn5tele_set_test_pattern},
	{SENSOR_FEATURE_SET_MAX_FRAME_RATE_BY_SCENARIO, chagalls5kjn5tele_set_max_framerate_by_scenario},
	{SENSOR_FEATURE_SEAMLESS_SWITCH, chagalls5kjn5tele_seamless_switch},
	{SENSOR_FEATURE_SET_MULTI_SHUTTER_FRAME_TIME,chagalls5kjn5tele_set_multi_shutter_frame_length},
	{SENSOR_FEATURE_SET_GAIN, chagalls5kjn5tele_set_gain},
	{SENSOR_FEATURE_SET_SHUTTER_FRAME_TIME, chagalls5kjn5tele_set_shutter_frame_length},
	{SENSOR_FEATURE_SET_ESHUTTER, chagalls5kjn5tele_set_shutter},
	{SENSOR_FEATURE_SET_AWB_GAIN, chagalls5kjn5tele_set_awb_gain},
};
...
static struct mtk_sensor_saturation_info chagalls5kjn5_saturation_info_10bit = {
	.gain_ratio = 1000,
	.OB_pedestal = 64,
	.saturation_level = 1023,
};

static struct mtk_sensor_saturation_info chagalls5kjn5_saturation_info_12bit = {
	.gain_ratio = 4000,
...
static struct mtk_sensor_saturation_info chagalls5kjn5_saturation_info_fake12bit = {
	.gain_ratio = 1000,
	.OB_pedestal = 256,
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info = {
	...
	.i4Crop = {
		...
		{128, 456}, {1088, 996}, {0, 0}, {0, 0}, {2048, 1536},
...
// mode 11 & 30: full size crop bayer
...
#define PRE_MODE	.frame_desc = frame_desc_prev,\
	...
	.mode_setting_table = chagalls5kjn5tele_preview_setting,\
	.mode_setting_len = ARRAY_SIZE(chagalls5kjn5tele_preview_setting),\
	.seamless_switch_group = SEAMLESS_SWITCH_GROUP_NORMAL_CAP_MODE,\
	.seamless_switch_mode_setting_table = chagalls5kjn5tele_preview_setting,\
	.seamless_switch_mode_setting_len = ARRAY_SIZE(chagalls5kjn5tele_preview_setting),\
	.hdr_mode = HDR_NONE,\
	.raw_cnt = 1,\
	.exp_cnt = 1,\
	.pclk = 920000000,\
...
static struct subdrv_mode_struct mode_struct[] = {
	...
	// complete 2
	{
		...
		.mode_setting_table = chagalls5kjn5tele_normal_video_setting,
		.mode_setting_len = ARRAY_SIZE(chagalls5kjn5tele_normal_video_setting),
	...
	//complete 3
	{
		...
		.mode_setting_table = chagalls5kjn5tele_custom1_setting,
		.mode_setting_len = ARRAY_SIZE(chagalls5kjn5tele_custom1_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	// custom2 mode 6 : 120 fps video
	//complete 14
	{
		.frame_desc = frame_desc_cus2,
		.num_entries = ARRAY_SIZE(frame_desc_cus2),
		.mode_setting_table = chagalls5kjn5tele_custom2_setting,
		.mode_setting_len = ARRAY_SIZE(chagalls5kjn5tele_custom2_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	// custom3 mode 7 : smvr 240fps video
	//complete 15
	{
		.frame_desc = frame_desc_cus3,
		.num_entries = ARRAY_SIZE(frame_desc_cus3),
		.mode_setting_table = chagalls5kjn5tele_custom3_setting,
		.mode_setting_len = ARRAY_SIZE(chagalls5kjn5tele_custom3_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	//complete 4
	{
		...
		.mode_setting_table = chagalls5kjn5tele_custom4_setting,
		.mode_setting_len = ARRAY_SIZE(chagalls5kjn5tele_custom4_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_HDR_CAP_MODE,
		.seamless_switch_mode_setting_table = chagalls5kjn5tele_custom4_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(chagalls5kjn5tele_custom4_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 920000000,
		...
		.saturation_info = &chagalls5kjn5_saturation_info_fake12bit,
		.awb_enabled = true,
	},
	...
	//complete 5
	{
		...
		.mode_setting_table = chagalls5kjn5tele_custom5_setting,
		.mode_setting_len = ARRAY_SIZE(chagalls5kjn5tele_custom5_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_HDR_CAP_MODE,
		.seamless_switch_mode_setting_table = chagalls5kjn5tele_custom5_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(chagalls5kjn5tele_custom5_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 920000000,
	...
	//complete 6
	{
		...
		.mode_setting_table = chagalls5kjn5tele_custom7_setting,
		.mode_setting_len = ARRAY_SIZE(chagalls5kjn5tele_custom7_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_HDR_CAP_MODE,
		.seamless_switch_mode_setting_table = chagalls5kjn5tele_custom7_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(chagalls5kjn5tele_custom7_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 920000000,
	...
	//complete 0
	{
		...
		.mode_setting_table = chagalls5kjn5tele_custom8_setting,
		.mode_setting_len = ARRAY_SIZE(chagalls5kjn5tele_custom8_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_NORMAL_CAP_MODE,
		.seamless_switch_mode_setting_table = chagalls5kjn5tele_custom8_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(chagalls5kjn5tele_custom8_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 920000000,
	...
	//complete 12
	{
		...
		.mode_setting_table = chagalls5kjn5tele_custom9_setting,
		.mode_setting_len = ARRAY_SIZE(chagalls5kjn5tele_custom9_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	//complete 8
	{
		...
		.mode_setting_len = ARRAY_SIZE(chagalls5kjn5tele_custom13_setting),
		.mode_setting_table = chagalls5kjn5tele_custom13_setting,
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_HDR_CAP_MODE,
		.seamless_switch_mode_setting_table = chagalls5kjn5tele_custom13_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(chagalls5kjn5tele_custom13_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 920000000,
	...
	//complete 7
	{
		...
		.mode_setting_table = chagalls5kjn5tele_custom15_setting,
		.mode_setting_len = ARRAY_SIZE(chagalls5kjn5tele_custom15_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_HDR_CAP_MODE,
		.seamless_switch_mode_setting_table = chagalls5kjn5tele_custom15_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(chagalls5kjn5tele_custom15_setting),
	...
	//complete 9
	{
		...
		.mode_setting_table = chagalls5kjn5tele_custom17_setting,
		.mode_setting_len = ARRAY_SIZE(chagalls5kjn5tele_custom17_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_VIDEO_1610_MODE,
		.seamless_switch_mode_setting_table = chagalls5kjn5tele_custom17_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(chagalls5kjn5tele_custom17_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 920000000,
	...
	//complete 10
	{
		...
		.mode_setting_table = chagalls5kjn5tele_custom18_setting,
		.mode_setting_len = ARRAY_SIZE(chagalls5kjn5tele_custom18_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_VIDEO_1610_MODE,
		.seamless_switch_mode_setting_table = chagalls5kjn5tele_custom18_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(chagalls5kjn5tele_custom18_setting),
		...
		.delay_frame = 2,
		.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW12_B,
		.saturation_info = &chagalls5kjn5_saturation_info_12bit,
	},
	//custom 19 mode 23: full size crop 16:10
	//4096x2560
	//complete 11
	{
		.frame_desc = frame_desc_cus19,
		.num_entries = ARRAY_SIZE(frame_desc_cus19),
		.mode_setting_table = chagalls5kjn5tele_custom19_setting,
		.mode_setting_len = ARRAY_SIZE(chagalls5kjn5tele_custom19_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_VIDEO_1610_MODE,
		.seamless_switch_mode_setting_table = chagalls5kjn5tele_custom19_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(chagalls5kjn5tele_custom19_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 920000000,
	...
	//custom22 mode 26: 2exp stagger 4:3
	//fake 12bit
	//complete 7
	{
		.frame_desc = frame_desc_cus15,
...
static struct subdrv_static_ctx static_ctx = {
	.sensor_id = CHAGALLS5KJN5TELE_SENSOR_ID,
	...
	.ana_gain_type = 1,
	.ana_gain_step = 1,
	.ana_gain_table = chagalls5kjn5tele_ana_gain_table,
	.ana_gain_table_size = sizeof(chagalls5kjn5tele_ana_gain_table),
	.tuning_iso_base = 50,
	.exposure_def = 0x3D0,
	.exposure_min = 4,
	...
	.exposure_step = 1,
	.exposure_margin = 12,
	.saturation_info = &chagalls5kjn5_saturation_info_10bit,

	.frame_length_max = 0x7FFF800,
	.ae_effective_frame = 3,
	.frame_time_delay_frame = 2,
	.start_exposure_offset = 1236800,
...
//	.reg_addr_auto_extend = PARAM_UNDEFINED,
	...
	.init_setting_table = chagalls5kjn5tele_init_setting,
	.init_setting_len = ARRAY_SIZE(chagalls5kjn5tele_init_setting),
	.mode = mode_struct,
...
static struct subdrv_ops ops = {
	.get_id = chagalls5kjn5tele_get_imgsensor_id,
	.init_ctx = init_ctx,
	.open = common_open,
	.get_info = common_get_info,
	.get_resolution = common_get_resolution,
	.control = chagalls5kjn5tele_control,
...
const struct subdrv_entry chagalls5kjn5tele_mipi_raw_entry = {
	.name = "chagalls5kjn5tele_mipi_raw",
	.id = CHAGALLS5KJN5TELE_SENSOR_ID,
	.pw_seq = pw_seq,
	...
	while (ctx->s_ctx.i2c_addr_table[i] != 0xFF) {
		...
		do {
			*sensor_id = (subdrv_ixc_rd_u8(ctx, addr_h) << 8) |
			...
			if (*sensor_id == ctx->s_ctx.sensor_id -2){
				return ERROR_NONE;
			}
			retry--;
		} while (retry > 0);
...
static int chagalls5kjn5tele_set_shutter_frame_length(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
	...
	chagalls5kjn5tele_set_long_exposure(ctx);
	/* write framelength */
	if (set_auto_flicker(ctx, 0) || frame_length || !ctx->s_ctx.reg_addr_auto_extend)
		chagalls5kjn5tele_write_frame_length(ctx, ctx->frame_length);
	else if (ctx->s_ctx.reg_addr_auto_extend)
		chagalls5kjn5tele_write_frame_length(ctx, ctx->min_frame_length);
	/* write shutter */
...
static int chagalls5kjn5tele_set_shutter(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
	chagalls5kjn5tele_set_shutter_frame_length(ctx, para, len);
	return 0;
}

void chagalls5kjn5tele_update_mode_info(struct subdrv_ctx *ctx, enum SENSOR_SCENARIO_ID_ENUM scenario_id)
{
	if (scenario_id >= ctx->s_ctx.sensor_mode_num)
	{
		DRV_LOGE(ctx, "invalid sid:%u, mode_num:%u\n",
...
void chagalls5kjn5tele_set_multi_shutter_frame_length_dol(struct subdrv_ctx *ctx,
...
void chagalls5kjn5tele_write_lens(struct subdrv_ctx *ctx)
{
	u16 len_macro = 0;
	u16 len_inf = 0;
	u8 *pbuf = NULL;
...
static int chagalls5kjn5tele_seamless_switch(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
	...
	chagalls5kjn5tele_update_mode_info(ctx, scenario_id);
	...
	chagalls5kjn5tele_set_awb_gain(ctx, (u8 *)&g_last_awb_gain, &retLen);
	i2c_table_write(ctx,
	...
	if (ae_ctrl) {
		...
		case HDR_RAW_STAGGER:
			chagalls5kjn5tele_set_multi_shutter_frame_length_dol(ctx, (u64 *)&ae_ctrl->exposure, exp_cnt, 0);
			set_multi_gain(ctx, (u32 *)&ae_ctrl->gain, exp_cnt);
			break;
		case HDR_RAW_DCG_COMPOSE:
			set_multi_shutter_frame_length(ctx, (u64 *)&ae_ctrl->exposure, 1, 0);
			chagalls5kjn5tele_set_gain(ctx, (u8 *)&ae_ctrl->gain.le_gain,len);
			break;
		default:
			chagalls5kjn5tele_set_shutter_frame_length(ctx, (u8 *)&ae_ctrl->exposure.le_exposure,len);
	...
	if(ctx->s_ctx.mode[scenario_id].imgsensor_winsize_info.w2_tg_size == 8192)
		chagalls5kjn5tele_write_lens(ctx);

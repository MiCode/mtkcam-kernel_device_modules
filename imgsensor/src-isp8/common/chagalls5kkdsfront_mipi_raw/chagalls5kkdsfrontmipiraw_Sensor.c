 ...
 * Filename:
 * ---------
 *     chagalls5kkdsfrontmipiraw_Sensor.c
 *
 * Project:
 * --------
 *     ALPS
 ...
 *============================================================================
 ****************************************************************************/
#include "chagalls5kkdsfrontmipiraw_Sensor.h"
#include <linux/timer.h>
#include "adaptor-ctrls.h"
#define DEBUG_LOG_EN 0
#define PFX "CHAGALLS5KKDSFRONT_camera_sensor"
...
static int chagalls5kkdsfront_get_imgsensor_id(struct subdrv_ctx *ctx, u32 *sensor_id);
...
static int chagalls5kkdsfront_set_test_pattern(struct subdrv_ctx *ctx, u8 *para, u32 *len);
/* STRUCT */
static struct subdrv_feature_control feature_control_list[] = {
	{
		.feature_id = SENSOR_FEATURE_SET_TEST_PATTERN,
		.func = chagalls5kkdsfront_set_test_pattern
	},
};
...
static struct subdrv_mode_struct mode_struct[] = {
	{	/* mode 0 : preview 3280x2464@30fps */
		.mode_setting_table = chagalls5kkdsfront_preview_setting,
		.mode_setting_len = ARRAY_SIZE(chagalls5kkdsfront_preview_setting),
	...
	{	/* mode 2 : normal video 3280x1848@30fps */
		.mode_setting_table = chagalls5kkdsfront_custom6_setting,
		.mode_setting_len = ARRAY_SIZE(chagalls5kkdsfront_custom6_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	{	/* mode : 3 hs_video 1080p@120fps */
		.mode_setting_table = chagalls5kkdsfront_hs_video_setting,
		.mode_setting_len = ARRAY_SIZE(chagalls5kkdsfront_hs_video_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	{	/* mode 5 : video 60fps 3280x2052@60FPS */
		.mode_setting_table = chagalls5kkdsfront_custom1_setting,
		.mode_setting_len = ARRAY_SIZE(chagalls5kkdsfront_custom1_setting),
	...
	{	/* mode : 6  812x612@10FPS */
		.mode_setting_table = chagalls5kkdsfront_custom2_setting,
		.mode_setting_len = ARRAY_SIZE(chagalls5kkdsfront_custom2_setting),
		.mode_setting_table_for_md = chagalls5kkdsfront_md1_setting,
		.mode_setting_len_for_md = ARRAY_SIZE(chagalls5kkdsfront_md1_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	{	/* mode : 7  812x612@20FPS */
		.mode_setting_table = chagalls5kkdsfront_custom3_setting,
		.mode_setting_len = ARRAY_SIZE(chagalls5kkdsfront_custom3_setting),
		.mode_setting_table_for_md = chagalls5kkdsfront_md1_setting,
		.mode_setting_len_for_md = ARRAY_SIZE(chagalls5kkdsfront_md1_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
	...
	{	/* mode : 8  812x612@30FPS */
		.mode_setting_table = chagalls5kkdsfront_custom4_setting,
		.mode_setting_len = ARRAY_SIZE(chagalls5kkdsfront_custom4_setting),
		.mode_setting_table_for_md = chagalls5kkdsfront_md1_setting,
		.mode_setting_len_for_md = ARRAY_SIZE(chagalls5kkdsfront_md1_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
	...
	{	/* mode 10 : normal video 3280x2052@30fps */
		.mode_setting_table = chagalls5kkdsfront_normal_video_setting,
		.mode_setting_len = ARRAY_SIZE(chagalls5kkdsfront_normal_video_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	{	/* mode 11 : video 60fps 3280x1848@60FPS as mode 5*/
		.mode_setting_table = chagalls5kkdsfront_custom1_setting,
		.mode_setting_len = ARRAY_SIZE(chagalls5kkdsfront_custom1_setting),
		.mode_setting_table_for_md = PARAM_UNDEFINED,
		.mode_setting_len_for_md = PARAM_UNDEFINED,
...
static struct subdrv_static_ctx static_ctx = {
	.sensor_id = CHAGALLS5KKDSFRONT_SENSOR_ID,
	...
	.ana_gain_type = 2,
	.ana_gain_step = 32,
	.ana_gain_table = chagalls5kkdsfront_ana_gain_table,
	.ana_gain_table_size = sizeof(chagalls5kkdsfront_ana_gain_table),
	.tuning_iso_base = 50,
	.exposure_def = 0x3D0,
	.exposure_min = 5,
	...
	.init_setting_table = chagalls5kkdsfront_init_setting,
	.init_setting_len = ARRAY_SIZE(chagalls5kkdsfront_init_setting),
	.mode = mode_struct,
...
static struct subdrv_ops ops = {
	.init_ctx = init_ctx,
	.open = common_open,
	.get_id = chagalls5kkdsfront_get_imgsensor_id,
...
const struct subdrv_entry chagalls5kkdsfront_mipi_raw_entry = {
	.name = SENSOR_DRVNAME_CHAGALLS5KKDSFRONT_MIPI_RAW,
	.id = CHAGALLS5KKDSFRONT_SENSOR_ID,
	.pw_seq = pw_seq,

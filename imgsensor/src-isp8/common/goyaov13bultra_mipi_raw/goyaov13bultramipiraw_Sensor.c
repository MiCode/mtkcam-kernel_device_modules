 ...
 * Filename:
 * ---------
 *	 goyaov13bultramipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
 ...
 *============================================================================
 ****************************************************************************/
#include "goyaov13bultramipiraw_Sensor.h"

static void set_group_hold(void *arg, u8 en);
static void goyaov13bultra_set_dummy(struct subdrv_ctx *ctx);
static int goyaov13bultra_set_max_framerate_by_scenario(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static u16 get_gain2reg(u32 gain);
static int goyaov13bultra_get_imgsensor_id(struct subdrv_ctx *ctx, u32 *sensor_id);
static int goyaov13bultra_set_test_pattern(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int init_ctx(struct subdrv_ctx *ctx,	struct i2c_client *i2c_client, u8 i2c_write_id);
static int ultra_vsync_notify(struct subdrv_ctx *ctx, unsigned int sof_cnt);
static int goyaov13bultra_set_shutter_frame_length(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int goyaov13bultra_set_shutter(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int goyaov13bultra_set_multi_shutter_frame_length(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int goyaov13bultra_set_multi_dig_gain(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int goyaov13bultra_get_csi_param(struct subdrv_ctx *ctx, enum SENSOR_SCENARIO_ID_ENUM scenario_id, struct mtk_csi_param *csi_param);

/* STRUCT */
static struct subdrv_feature_control feature_control_list[] = {
	{SENSOR_FEATURE_SET_TEST_PATTERN, goyaov13bultra_set_test_pattern},
	{SENSOR_FEATURE_SET_MAX_FRAME_RATE_BY_SCENARIO, goyaov13bultra_set_max_framerate_by_scenario},
	{SENSOR_FEATURE_SET_ESHUTTER, goyaov13bultra_set_shutter},
	{SENSOR_FEATURE_SET_SHUTTER_FRAME_TIME, goyaov13bultra_set_shutter_frame_length},
	{SENSOR_FEATURE_SET_MULTI_SHUTTER_FRAME_TIME, goyaov13bultra_set_multi_shutter_frame_length},
	{SENSOR_FEATURE_SET_MULTI_DIG_GAIN, goyaov13bultra_set_multi_dig_gain}
};
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info =
{
	...
	.i4Crop = {
		{0, 0}, {0, 0}, {0, 372}, {0, 0}, {0, 0}, {0, 372}, {80, 60}, {80, 60}, {1040, 780}, {1040, 780}, {1040, 780}, {1040, 780}, {0, 250}
	},
...
{\
	...
	.mode_setting_table = goyaov13bultra_preview_setting,\
	.mode_setting_len = ARRAY_SIZE(goyaov13bultra_preview_setting),\
...
{\
	...
	.mode_setting_table = goyaov13bultra_normal_video_setting,\
	.mode_setting_len = ARRAY_SIZE(goyaov13bultra_normal_video_setting),\
	.seamless_switch_group = PARAM_UNDEFINED,\
	.seamless_switch_mode_setting_table = PARAM_UNDEFINED,\
	.seamless_switch_mode_setting_len = PARAM_UNDEFINED,\
	.hdr_mode = HDR_NONE,\
...
{\
	...
	.mode_setting_table = goyaov13bultra_custom1_setting,\
	.mode_setting_len = ARRAY_SIZE(goyaov13bultra_custom1_setting),\
	.seamless_switch_group = PARAM_UNDEFINED,\
	.seamless_switch_mode_setting_table = PARAM_UNDEFINED,\
	.seamless_switch_mode_setting_len = PARAM_UNDEFINED,\
	.hdr_mode = HDR_NONE,\
...
{\
	...
	.mode_setting_table = goyaov13bultra_custom2_setting,\
	.mode_setting_len = ARRAY_SIZE(goyaov13bultra_custom2_setting),\
	.seamless_switch_group = PARAM_UNDEFINED,\
	.seamless_switch_mode_setting_table = PARAM_UNDEFINED,\
	.seamless_switch_mode_setting_len = PARAM_UNDEFINED,\
	.hdr_mode = HDR_NONE,\
...
{\
	...
	.mode_setting_table = goyaov13bultra_custom3_setting,\
	.mode_setting_len = ARRAY_SIZE(goyaov13bultra_custom3_setting),\
	.seamless_switch_group = PARAM_UNDEFINED,\
	.seamless_switch_mode_setting_table = PARAM_UNDEFINED,\
	.seamless_switch_mode_setting_len = PARAM_UNDEFINED,\
	.hdr_mode = HDR_NONE,\
...
{\
	...
	.mode_setting_table = goyaov13bultra_custom4_setting,\
	.mode_setting_len = ARRAY_SIZE(goyaov13bultra_custom4_setting),\
	.seamless_switch_group = PARAM_UNDEFINED,\
	.seamless_switch_mode_setting_table = PARAM_UNDEFINED,\
	.seamless_switch_mode_setting_len = PARAM_UNDEFINED,\
	.hdr_mode = HDR_NONE,\
...
static struct subdrv_mode_struct mode_struct[] = {
	...
	bokeh2_mode_struct,         //mode 10 leica authentic Mode
	bokeh2_mode_struct,         //mode 11 leica authentic Mode
	video_mode_struct           //mode 12
};

static struct subdrv_static_ctx static_ctx = {
	.sensor_id = GOYAOV13BULTRA_SENSOR_ID,
	...
	.ana_gain_type = 1,
	.ana_gain_step = 1,
	.ana_gain_table = goyaov13bultra_ana_gain_table,
	.ana_gain_table_size = sizeof(goyaov13bultra_ana_gain_table),
	.tuning_iso_base = 50,
	.exposure_def = 0x3D0,
	.exposure_min = 4,
	...
	.init_setting_table = goyaov13bultra_init_setting,
	.init_setting_len = ARRAY_SIZE(goyaov13bultra_init_setting),
	.mode = mode_struct,
...
static struct subdrv_ops ops = {
	.get_id = goyaov13bultra_get_imgsensor_id,
	.init_ctx = init_ctx,
	.open = common_open,
	...
	.get_csi_param = goyaov13bultra_get_csi_param,
...
const struct subdrv_entry goyaov13bultra_mipi_raw_entry = {
	.name = SENSOR_DRVNAME_GOYAOV13BULTRA_MIPI_RAW,
	.id = GOYAOV13BULTRA_SENSOR_ID,
	.pw_seq = pw_seq,
...
static int goyaov13bultra_set_shutter(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
	goyaov13bultra_set_shutter_frame_length(ctx, para, len);
	return 0;
}
static int goyaov13bultra_set_multi_shutter_frame_length(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
...
static int goyaov13bultra_get_csi_param(struct subdrv_ctx *ctx,

...
static struct subdrv_mode_struct mode_struct[] = {
	...
	// custom1 mode 5
	// Mode_19 4096x2304_binning_4C2PlusSCG_crop_10bit_30fps_PDDT_4096x576_Max_A_gain_63.75x
	// PD size = 4096x576
	// Tline = 5.333us
	// VB = 4.395 ms
	// version:2025-0306_v1.9
	...
	// custom18 version:2025-0306_v1.9 22: 14bit  video DCG
...
if (ctx->s_ctx.mode[ctx->current_scenario_id].hdr_mode == HDR_RAW_STAGGER) {
	...
	+ ctx->s_ctx.mode[ctx->current_scenario_id].read_margin;
	DRV_LOG(ctx,
		"calc_fl[0](%u) calc_fl[1]%u, calc_fl[2]%u, exp-LE/ME/SE (%u/%u/%u),shutter-LE/ME/SE (%u/%u/%u)\
		read_margin(%u)\
		readout_length(%d)\n",\
		calc_fl[0],calc_fl[1],calc_fl[2],ctx->exposure[0],ctx->exposure[1],ctx->exposure[2],\
...
static int goyaovx8000wide_seamless_switch(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
	...
	if (scenario_id == SENSOR_SCENARIO_ID_CUSTOM13 ||

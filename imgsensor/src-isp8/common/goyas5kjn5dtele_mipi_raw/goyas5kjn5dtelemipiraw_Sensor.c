 ...
 * Filename:
 * ---------
 *	 goyas5kjn5dtelemipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
 ...
 *============================================================================
 ****************************************************************************/
#include "goyas5kjn5dtelemipiraw_Sensor.h"

static int goyas5kjn5dtele_get_imgsensor_id(struct subdrv_ctx *ctx, u32 *sensor_id);
static int get_sensor_temperature(void *arg);
static void set_group_hold(void *arg, u8 en);
static int goyas5kjn5dtele_set_max_framerate_by_scenario(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static u16 get_gain2reg(u32 gain);
static int goyas5kjn5dtele_control(struct subdrv_ctx *ctx, enum MSDK_SCENARIO_ID_ENUM scenario_id,
		MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
		MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data);
static int goyas5kjn5dtele_set_test_pattern(struct subdrv_ctx *ctx, u8 *para, u32 *len);
...
static int goyas5kjn5dtele_seamless_switch(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int goyas5kjn5dtele_set_multi_shutter_frame_length(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int goyas5kjn5dtele_set_gain(struct subdrv_ctx *ctx, u8 *para, u32 *len);
void goyas5kjn5dtele_set_long_exposure(struct subdrv_ctx *ctx);
void goyas5kjn5dtele_write_frame_length(struct subdrv_ctx *ctx, u32 fll);
static int goyas5kjn5dtele_set_shutter_frame_length(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int goyas5kjn5dtele_set_shutter(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int goyas5kjn5dtele_set_awb_gain(struct subdrv_ctx *ctx, u8 *para, u32 *len);
...
static struct subdrv_feature_control feature_control_list[] = {
	{SENSOR_FEATURE_SET_TEST_PATTERN, goyas5kjn5dtele_set_test_pattern},
	{SENSOR_FEATURE_SET_MAX_FRAME_RATE_BY_SCENARIO, goyas5kjn5dtele_set_max_framerate_by_scenario},
	{SENSOR_FEATURE_SEAMLESS_SWITCH, goyas5kjn5dtele_seamless_switch},
	{SENSOR_FEATURE_SET_MULTI_SHUTTER_FRAME_TIME,goyas5kjn5dtele_set_multi_shutter_frame_length},
	{SENSOR_FEATURE_SET_GAIN, goyas5kjn5dtele_set_gain},
	{SENSOR_FEATURE_SET_SHUTTER_FRAME_TIME, goyas5kjn5dtele_set_shutter_frame_length},
	{SENSOR_FEATURE_SET_ESHUTTER, goyas5kjn5dtele_set_shutter},
	{SENSOR_FEATURE_SET_AWB_GAIN, goyas5kjn5dtele_set_awb_gain},
};
...
static struct mtk_sensor_saturation_info goyas5kjn5d_saturation_info_10bit = {
	.gain_ratio = 1000,
	.OB_pedestal = 64,
	.saturation_level = 1023,
};

static struct mtk_sensor_saturation_info goyas5kjn5d_saturation_info_12bit = {
	.gain_ratio = 4000,
...
static struct mtk_sensor_saturation_info goyas5kjn5d_saturation_info_fake12bit = {
	.gain_ratio = 1000,
	.OB_pedestal = 256,
...
// mode 0/1/4/14/15/16/20/31: 4096*3072@30fps, normal preview + pd
...
#define PRE_MODE	.frame_desc = frame_desc_prev,\
	...
	.mode_setting_table = goyas5kjn5dtele_preview_setting,\
	.mode_setting_len = ARRAY_SIZE(goyas5kjn5dtele_preview_setting),\
	.seamless_switch_group = SEAMLESS_SWITCH_GROUP_NORMAL_CAP_MODE,\
	.seamless_switch_mode_setting_table = goyas5kjn5dtele_preview_setting,\
	.seamless_switch_mode_setting_len = ARRAY_SIZE(goyas5kjn5dtele_preview_setting),\
	.hdr_mode = HDR_NONE,\
	.raw_cnt = 1,\
	.exp_cnt = 1,\
	.pclk = 920000000,\
...
static struct subdrv_mode_struct mode_struct[] = {
	...
	// complete 18
	{
		...
		.mode_setting_table = goyas5kjn5dtele_normal_video_setting,
		.mode_setting_len = ARRAY_SIZE(goyas5kjn5dtele_normal_video_setting),
	...
	//complete 19
	{
		...
		.mode_setting_table = goyas5kjn5dtele_hs_video_setting,
		.mode_setting_len = ARRAY_SIZE(goyas5kjn5dtele_hs_video_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	// custom4 mode 8 
	//8192*6144@15fps; full size quad；4:3；fake12 bit
	//complete 5
	{
		.frame_desc = frame_desc_cus4,
		.num_entries = ARRAY_SIZE(frame_desc_cus4),
		.mode_setting_table = goyas5kjn5dtele_custom4_setting,
		.mode_setting_len = ARRAY_SIZE(goyas5kjn5dtele_custom4_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_HDR_CAP_MODE,
		.seamless_switch_mode_setting_table = goyas5kjn5dtele_custom4_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(goyas5kjn5dtele_custom4_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 920000000,
		...
		.fine_integ_line = 0,
		.delay_frame = 2,
		.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW12_4CELL_Gr,
		.saturation_info = &goyas5kjn5d_saturation_info_fake12bit,
		.awb_enabled = true,
	},
	...
	//complete 7
	{
		...
		.mode_setting_table = goyas5kjn5dtele_custom5_setting,
		.mode_setting_len = ARRAY_SIZE(goyas5kjn5dtele_custom5_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_HDR_CAP_MODE,
		.seamless_switch_mode_setting_table = goyas5kjn5dtele_custom5_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(goyas5kjn5dtele_custom5_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 920000000,
	...
	// custom6 mode 10 : full size bayer；4:3； fake12 bit
	//8192x6144
	//complete 4
	{
		.frame_desc = frame_desc_cus6,
		.num_entries = ARRAY_SIZE(frame_desc_cus6),
		.mode_setting_table = goyas5kjn5dtele_custom6_setting,
		.mode_setting_len = ARRAY_SIZE(goyas5kjn5dtele_custom6_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_HDR_CAP_MODE,
		.seamless_switch_mode_setting_table = goyas5kjn5dtele_custom6_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(goyas5kjn5dtele_custom6_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 920000000,
	...
	//complete 6
	{
		...
		.mode_setting_table = goyas5kjn5dtele_custom7_setting,
		.mode_setting_len = ARRAY_SIZE(goyas5kjn5dtele_custom7_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_HDR_CAP_MODE,
		.seamless_switch_mode_setting_table = goyas5kjn5dtele_custom7_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(goyas5kjn5dtele_custom7_setting),
	...
	//complete 1
	{
		...
		.mode_setting_table = goyas5kjn5dtele_custom8_setting,
		.mode_setting_len = ARRAY_SIZE(goyas5kjn5dtele_custom8_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_NORMAL_CAP_MODE,
		.seamless_switch_mode_setting_table = goyas5kjn5dtele_custom8_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(goyas5kjn5dtele_custom8_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 920000000,
	...
	//complete 2
	{
		...
		.mode_setting_table = goyas5kjn5dtele_custom9_setting,
		.mode_setting_len = ARRAY_SIZE(goyas5kjn5dtele_custom9_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_NORMAL_CAP_MODE,
		.seamless_switch_mode_setting_table = goyas5kjn5dtele_custom9_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(goyas5kjn5dtele_custom9_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 920000000,
	...
	//complete 9
	{
		...
		.mode_setting_len = ARRAY_SIZE(goyas5kjn5dtele_custom13_setting),
		.mode_setting_table = goyas5kjn5dtele_custom13_setting,
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_HDR_CAP_MODE,
		.seamless_switch_mode_setting_table = goyas5kjn5dtele_custom13_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(goyas5kjn5dtele_custom13_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 920000000,
	...
	//custom14 mode 18: fullsize DXG(x)
	//complete 8
	{
		.frame_desc = frame_desc_cus14,
		.num_entries = ARRAY_SIZE(frame_desc_cus14),
		.mode_setting_table = goyas5kjn5dtele_custom14_setting,
		.mode_setting_len = ARRAY_SIZE(goyas5kjn5dtele_custom14_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_HDR_CAP_MODE,
		.seamless_switch_mode_setting_table = goyas5kjn5dtele_custom14_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(goyas5kjn5dtele_custom14_setting),
		...
		.fine_integ_line = 0,
		.delay_frame = 2,
		.saturation_info = &goyas5kjn5d_saturation_info_12bit,
		.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW12_Gr,
	},
	//custom15 mode 19: 2exp stagger
	//fake 12bit; 4096*3072@24fps
	//complete 10
	{
		.frame_desc = frame_desc_cus15,
		.num_entries = ARRAY_SIZE(frame_desc_cus15),
		.mode_setting_table = goyas5kjn5dtele_custom15_setting,
		.mode_setting_len = ARRAY_SIZE(goyas5kjn5dtele_custom15_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_HDR_CAP_MODE,
		.seamless_switch_mode_setting_table = goyas5kjn5dtele_custom15_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(goyas5kjn5dtele_custom15_setting),
		.hdr_mode = HDR_RAW_STAGGER,
		.raw_cnt = 2,
		.exp_cnt = 2,
		.pclk = 920000000,
	...
	//custom 17 mode 21: 
	//4096x2560@30fps; fake12 bit
	//complete 11 
	//
	{
		.frame_desc = frame_desc_cus17,
		.num_entries = ARRAY_SIZE(frame_desc_cus17),
		.mode_setting_table = goyas5kjn5dtele_custom17_setting,
		.mode_setting_len = ARRAY_SIZE(goyas5kjn5dtele_custom17_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_VIDEO_1610_MODE,
		.seamless_switch_mode_setting_table = goyas5kjn5dtele_custom17_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(goyas5kjn5dtele_custom17_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 920000000,
	...
	//complete 12
	{
		...
		.mode_setting_table = goyas5kjn5dtele_custom18_setting,
		.mode_setting_len = ARRAY_SIZE(goyas5kjn5dtele_custom18_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_VIDEO_1610_MODE,
		.seamless_switch_mode_setting_table = goyas5kjn5dtele_custom18_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(goyas5kjn5dtele_custom18_setting),
		.hdr_mode = HDR_RAW_DCG_COMPOSE,
		.raw_cnt = 1,
		.exp_cnt = 2,
		.pclk = 920000000,
	...
	//complete 13
	{
		...
		.mode_setting_table = goyas5kjn5dtele_custom19_setting,
		.mode_setting_len = ARRAY_SIZE(goyas5kjn5dtele_custom19_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_VIDEO_1610_MODE,
		.seamless_switch_mode_setting_table = goyas5kjn5dtele_custom19_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(goyas5kjn5dtele_custom19_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 920000000,
...
static struct subdrv_static_ctx static_ctx = {
	.sensor_id = GOYAS5KJN5DTELE_SENSOR_ID,
	...
	.ana_gain_type = 1,
	.ana_gain_step = 1,
	.ana_gain_table = goyas5kjn5dtele_ana_gain_table,
	.ana_gain_table_size = sizeof(goyas5kjn5dtele_ana_gain_table),
	.tuning_iso_base = 50,
	.exposure_def = 0x3D0,
	.exposure_min = 4,
	...
	.exposure_step = 2,
	.exposure_margin = 12,
	.saturation_info = &goyas5kjn5d_saturation_info_10bit,
...
//	.reg_addr_auto_extend = PARAM_UNDEFINED,
	...
	.init_setting_table = goyas5kjn5dtele_init_setting,
	.init_setting_len = ARRAY_SIZE(goyas5kjn5dtele_init_setting),
	.mode = mode_struct,
...
static struct subdrv_ops ops = {
	.get_id = goyas5kjn5dtele_get_imgsensor_id,
	.init_ctx = init_ctx,
	.open = common_open,
	.get_info = common_get_info,
	.get_resolution = common_get_resolution,
	.control = goyas5kjn5dtele_control,
...
static struct subdrv_pw_seq_entry pw_seq[] = {
	...
	{HW_ID_RST,   {1},       0},
	{HW_ID_MCLK,  {24},	   0},
	{HW_ID_MCLK_DRIVING_CURRENT, {6}, 10000},
};

const struct subdrv_entry goyas5kjn5dtele_mipi_raw_entry = {
	.name = SENSOR_DRVNAME_GOYAS5KJN5DTELE_MIPI_RAW,
	.id = GOYAS5KJN5DTELE_SENSOR_ID,
	.pw_seq = pw_seq,
	...
	while (ctx->s_ctx.i2c_addr_table[i] != 0xFF) {
		...
		do {
			*sensor_id = (subdrv_ixc_rd_u8(ctx, addr_h) << 8) |
			...
			if (*sensor_id == ctx->s_ctx.sensor_id - 1)
				return ERROR_NONE;
			retry--;
		} while (retry > 0);
		i++;
		...
		MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	switch (switch_group)
	{
		case SEAMLESS_SWITCH_GROUP_NORMAL_CAP_MODE:
			DRV_LOG(ctx, "fcm 1 is slect \n");
			i2c_table_write(ctx, goyas5kjn5dtele_fcm1_setting,
				ARRAY_SIZE(goyas5kjn5dtele_fcm1_setting));
			break;
		case SEAMLESS_SWITCH_GROUP_NORMAL_CAP_MODE_LCICA_AUTHENTIC:
		case SEAMLESS_SWITCH_GROUP_HDR_CAP_MODE:
			DRV_LOG(ctx, "fcm 2 is slect \n");
			i2c_table_write(ctx, goyas5kjn5dtele_fcm2_setting,
				ARRAY_SIZE(goyas5kjn5dtele_fcm2_setting));
			break;
		case SEAMLESS_SWITCH_GROUP_VIDEO_1610_MODE:
			DRV_LOG(ctx, "fcm 3 is slect \n");
			i2c_table_write(ctx, goyas5kjn5dtele_fcm3_setting,
				ARRAY_SIZE(goyas5kjn5dtele_fcm3_setting));
			break;
		case SEAMLESS_SWITCH_GROUP_VIDEO_1609_MODE:
			DRV_LOG(ctx, "fcm 4 is slect \n");
			i2c_table_write(ctx, goyas5kjn5dtele_fcm4_setting,
				ARRAY_SIZE(goyas5kjn5dtele_fcm4_setting));
			break;
		default:
...
#endif
	goyas5kjn5dtele_set_long_exposure(ctx);
	/* write framelength */
	if (set_auto_flicker(ctx, 0) || frame_length || !ctx->s_ctx.reg_addr_auto_extend)
		goyas5kjn5dtele_write_frame_length(ctx, ctx->frame_length);
	else if (ctx->s_ctx.reg_addr_auto_extend)
		goyas5kjn5dtele_write_frame_length(ctx, ctx->min_frame_length);
	/* write shutter */
...
static int goyas5kjn5dtele_set_shutter(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
	goyas5kjn5dtele_set_shutter_frame_length(ctx, para, len);
	return 0;
}
void goyas5kjn5dtele_update_mode_info(struct subdrv_ctx *ctx, enum SENSOR_SCENARIO_ID_ENUM scenario_id)
{
	if (scenario_id >= ctx->s_ctx.sensor_mode_num)
	{
		DRV_LOGE(ctx, "invalid sid:%u, mode_num:%u\n",
...
void goyas5kjn5dtele_set_multi_shutter_frame_length_dol(struct subdrv_ctx *ctx,
	u64 *shutters, u16 exp_cnt,	u16 frame_length)
{
	...
	calc_fl[0] += ctx->s_ctx.mode[ctx->current_scenario_id].exposure_margin;
	...
	if ((ctx->s_ctx.hdr_type & HDR_SUPPORT_STAGGER_DOL) &&
		...
		calc_fl[3] = (u32)shutters[0] + (u32)shutters[1] + ctx->readout_length;
		DRV_LOG(ctx,
			"calc_fl[3]: %u, exp-LE/ME/SE (%u/%u/%u), readout_length:%u\n",
			calc_fl[3],
...
static int goyas5kjn5dtele_seamless_switch(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
	...
	if (ctx->current_scenario_id == 19 || ctx->current_scenario_id == 26) {
	...
	goyas5kjn5dtele_update_mode_info(ctx, scenario_id);
	...
	goyas5kjn5dtele_set_awb_gain(ctx, (u8 *)&g_last_awb_gain, &retLen);
	i2c_table_write(ctx,
	...
	if (ae_ctrl) {
		...
		case HDR_RAW_STAGGER:
			goyas5kjn5dtele_set_multi_shutter_frame_length_dol(ctx, (u64 *)&ae_ctrl->exposure, exp_cnt, 0);
			set_multi_gain(ctx, (u32 *)&ae_ctrl->gain, exp_cnt);
			break;
		case HDR_RAW_DCG_COMPOSE:
			set_multi_shutter_frame_length(ctx, (u64 *)&ae_ctrl->exposure, 1, 0);
			goyas5kjn5dtele_set_gain(ctx, (u8 *)&ae_ctrl->gain.le_gain,len);
			break;
		default:
			goyas5kjn5dtele_set_shutter_frame_length(ctx, (u8 *)&ae_ctrl->exposure.le_exposure,len);

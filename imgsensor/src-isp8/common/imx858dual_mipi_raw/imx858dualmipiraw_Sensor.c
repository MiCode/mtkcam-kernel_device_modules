 ...
 *============================================================================
 ****************************************************************************/
#include "imx858dualmipiraw_Sensor.h"
...
static int imx858dual_seamless_switch(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int imx858dual_set_test_pattern(struct subdrv_ctx *ctx, u8 *para, u32 *len);
...
static struct subdrv_mode_struct mode_struct[] = {
	{//mode 0
		...
		.mode_setting_table = imx858dual_preview_setting,
		.mode_setting_len = ARRAY_SIZE(imx858dual_preview_setting),
		.seamless_switch_group = 1,
		.seamless_switch_mode_setting_table = imx858dual_seamless_preview,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(imx858dual_seamless_preview),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
	...
	{//mode 2
		...
		.mode_setting_table = imx858dual_normal_video_setting,
		.mode_setting_len = ARRAY_SIZE(imx858dual_normal_video_setting),
	...
	{//mode 5 2DOL
		...
		.mode_setting_table = imx858dual_custom1_setting,
		.mode_setting_len = ARRAY_SIZE(imx858dual_custom1_setting),
		.seamless_switch_group = 1,
		.seamless_switch_mode_setting_table = imx858dual_seamless_custom1,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(imx858dual_seamless_custom1),
	...
	{//mode 6 ISZ
		...
		.mode_setting_table = imx858dual_custom2_setting,
		.mode_setting_len = ARRAY_SIZE(imx858dual_custom2_setting),
		.seamless_switch_group = 1,
		.seamless_switch_mode_setting_table = imx858dual_seamless_custom2,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(imx858dual_seamless_custom2),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 878400000,  // VTPXCK system pixel rate
...
static struct subdrv_static_ctx static_ctx = {
	.sensor_id = IMX858DUAL_SENSOR_ID,
	.reg_addr_sensor_id = {0x0016, 0x0017},
	.i2c_addr_table = {0x67,0x66, 0x53, 0x52, 0xFF},
	...
	.init_setting_table = imx858dual_init_setting,
	.init_setting_len = ARRAY_SIZE(imx858dual_init_setting),
	.mode = mode_struct,
...
static struct subdrv_ops ops = {
	...
	.mcss_set_mask_frame = imx858dual_mcss_set_mask_frame,
};
...
static struct subdrv_pw_seq_entry pw_seq[] = {
	...
	{HW_ID_AVDD2, {1800000, 1800000}, 0}, // pmic_gpo(2.8V ldo) for avdd
	{HW_ID_AVDD, {2800000, 2800000}, 0}, // pmic_ldo for avdd
	{HW_ID_AVDD4, {1800000, 1800000}, 0}, // pmic_ldo/pmic_gpo(1.8V ldo) for avdd1
	{HW_ID_AFVDD1, {1800000, 1800000}, 0}, // pmic_gpo(2.8V ldo) for afvdd
...
const struct subdrv_entry imx858dual_mipi_raw_entry = {
	.name = "imx858dual_mipi_raw",
	.id = IMX858DUAL_SENSOR_ID,
	.pw_seq = pw_seq,

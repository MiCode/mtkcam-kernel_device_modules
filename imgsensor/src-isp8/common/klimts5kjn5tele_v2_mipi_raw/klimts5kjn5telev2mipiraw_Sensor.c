 ...
 * Filename:
 * ---------
 *	 klimts5kjn5tele_v2mipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
 ...
 *============================================================================
 ****************************************************************************/
#include "klimts5kjn5telev2mipiraw_Sensor.h"

static int get_sensor_temperature(void *arg);
static void set_group_hold(void *arg, u8 en);
static int klimts5kjn5tele_v2_set_max_framerate_by_scenario(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static u16 get_gain2reg(u32 gain);
static int klimts5kjn5tele_v2_get_imgsensor_id(struct subdrv_ctx *ctx, u32 *sensor_id);
static int klimts5kjn5tele_v2_control(struct subdrv_ctx *ctx, enum MSDK_SCENARIO_ID_ENUM scenario_id,
		MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
		MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data);
static int klimts5kjn5tele_v2_set_test_pattern(struct subdrv_ctx *ctx, u8 *para, u32 *len);
...
static int klimts5kjn5tele_v2_seamless_switch(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int klimts5kjn5tele_v2_set_multi_shutter_frame_length(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int klimts5kjn5tele_v2_set_gain(struct subdrv_ctx *ctx, u8 *para, u32 *len);
void klimts5kjn5tele_v2_set_long_exposure(struct subdrv_ctx *ctx);
void klimts5kjn5tele_v2_write_frame_length(struct subdrv_ctx *ctx, u32 fll);
static int klimts5kjn5tele_v2_set_shutter_frame_length(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int klimts5kjn5tele_v2_set_shutter(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int klimts5kjn5tele_v2_set_awb_gain(struct subdrv_ctx *ctx, u8 *para, u32 *len);
...
static struct subdrv_feature_control feature_control_list[] = {
	{SENSOR_FEATURE_SET_TEST_PATTERN, klimts5kjn5tele_v2_set_test_pattern},
	{SENSOR_FEATURE_SET_MAX_FRAME_RATE_BY_SCENARIO, klimts5kjn5tele_v2_set_max_framerate_by_scenario},
	{SENSOR_FEATURE_SEAMLESS_SWITCH, klimts5kjn5tele_v2_seamless_switch},
	{SENSOR_FEATURE_SET_MULTI_SHUTTER_FRAME_TIME,klimts5kjn5tele_v2_set_multi_shutter_frame_length},
	{SENSOR_FEATURE_SET_GAIN, klimts5kjn5tele_v2_set_gain},
	{SENSOR_FEATURE_SET_SHUTTER_FRAME_TIME, klimts5kjn5tele_v2_set_shutter_frame_length},
	{SENSOR_FEATURE_SET_ESHUTTER, klimts5kjn5tele_v2_set_shutter},
	{SENSOR_FEATURE_SET_AWB_GAIN, klimts5kjn5tele_v2_set_awb_gain},
};
...
static struct mtk_sensor_saturation_info klimts5kjn5_v2_saturation_info_10bit = {
	.gain_ratio = 1000,
	.OB_pedestal = 64,
	.saturation_level = 1023,
};

static struct mtk_sensor_saturation_info klimts5kjn5_v2_saturation_info_12bit = {
	.gain_ratio = 4000,
...
static struct mtk_sensor_saturation_info klimts5kjn5_v2_saturation_info_fake12bit = {
	.gain_ratio = 1000,
	.OB_pedestal = 256,
...
#define PRE_MODE	.frame_desc = frame_desc_prev,\
	...
	.mode_setting_table = klimts5kjn5tele_v2_preview_setting,\
	.mode_setting_len = ARRAY_SIZE(klimts5kjn5tele_v2_preview_setting),\
	.seamless_switch_group = SEAMLESS_SWITCH_GROUP_NORMAL_CAP_MODE,\
	.seamless_switch_mode_setting_table = klimts5kjn5tele_v2_preview_setting,\
	.seamless_switch_mode_setting_len = ARRAY_SIZE(klimts5kjn5tele_v2_preview_setting),\
	.hdr_mode = HDR_NONE,\
	.raw_cnt = 1,\
	.exp_cnt = 1,\
	.pclk = 920000000,\
...
static struct subdrv_mode_struct mode_struct[] = {
	...
	// complete 12 (18->12) v1.6zzq_0808
	{
		.frame_desc = frame_desc_vid,
		.num_entries = ARRAY_SIZE(frame_desc_vid),
		.mode_setting_table = klimts5kjn5tele_v2_normal_video_setting,
		.mode_setting_len = ARRAY_SIZE(klimts5kjn5tele_v2_normal_video_setting),
	...
	//complete 19
	{
		...
		.mode_setting_table = klimts5kjn5tele_v2_hs_video_setting,
		.mode_setting_len = ARRAY_SIZE(klimts5kjn5tele_v2_hs_video_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	//full size quad 4:3 
	//8192 6144
	//complete 3 (5->3) v1.6zzq_0808
	{
		.frame_desc = frame_desc_cus4,
		.num_entries = ARRAY_SIZE(frame_desc_cus4),
		.mode_setting_table = klimts5kjn5tele_v2_custom4_setting,
		.mode_setting_len = ARRAY_SIZE(klimts5kjn5tele_v2_custom4_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_HDR_CAP_MODE,
		.seamless_switch_mode_setting_table = klimts5kjn5tele_v2_custom4_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(klimts5kjn5tele_v2_custom4_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 920000000,
		...
		.saturation_info = &klimts5kjn5_v2_saturation_info_fake12bit,
		.awb_enabled = true,
	},
	// custom5 mode 9 : full size crop quad 4:3 fake12 bit
	//4096x3072
	//complete 5 (7->5) v1.6zzq_0808
	{
		.frame_desc = frame_desc_cus5,
		.num_entries = ARRAY_SIZE(frame_desc_cus5),
		.mode_setting_table = klimts5kjn5tele_v2_custom5_setting,
		.mode_setting_len = ARRAY_SIZE(klimts5kjn5tele_v2_custom5_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_HDR_CAP_MODE,
		.seamless_switch_mode_setting_table = klimts5kjn5tele_v2_custom5_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(klimts5kjn5tele_v2_custom5_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 920000000,
	...
	//complete 4
	{
		...
		.mode_setting_table = klimts5kjn5tele_v2_custom6_setting,
		.mode_setting_len = ARRAY_SIZE(klimts5kjn5tele_v2_custom6_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_HDR_CAP_MODE,
		.seamless_switch_mode_setting_table = klimts5kjn5tele_v2_custom6_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(klimts5kjn5tele_v2_custom6_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 920000000,
	...
	//4096x3072
	//complete 4 (6->4) v1.6zzq_0808
	{
		.frame_desc = frame_desc_cus7,
		.num_entries = ARRAY_SIZE(frame_desc_cus7),
		.mode_setting_table = klimts5kjn5tele_v2_custom7_setting,
		.mode_setting_len = ARRAY_SIZE(klimts5kjn5tele_v2_custom7_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_HDR_CAP_MODE,
		.seamless_switch_mode_setting_table = klimts5kjn5tele_v2_custom7_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(klimts5kjn5tele_v2_custom7_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 920000000,
	...
	//8192x6144
	//complete 0 (1->0) v1.6zzq_0808
	{
		.frame_desc = frame_desc_cus8,
		.num_entries = ARRAY_SIZE(frame_desc_cus8),
		.mode_setting_table = klimts5kjn5tele_v2_custom8_setting,
		.mode_setting_len = ARRAY_SIZE(klimts5kjn5tele_v2_custom8_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_NORMAL_CAP_MODE,
		.seamless_switch_mode_setting_table = klimts5kjn5tele_v2_custom8_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(klimts5kjn5tele_v2_custom8_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 920000000,
	...
	//complete 1 (2->1) v1.6zzq_0808
	{
		.frame_desc = frame_desc_cus9,
		.num_entries = ARRAY_SIZE(frame_desc_cus9),
		.mode_setting_table = klimts5kjn5tele_v2_custom9_setting,
		.mode_setting_len = ARRAY_SIZE(klimts5kjn5tele_v2_custom9_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	//fake 12bit
	//complete 7 (9->7) v1.6zzq_0808
	{
		.frame_desc = frame_desc_cus13,
		.num_entries = ARRAY_SIZE(frame_desc_cus13),
		.mode_setting_len = ARRAY_SIZE(klimts5kjn5tele_v2_custom13_setting),
		.mode_setting_table = klimts5kjn5tele_v2_custom13_setting,
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_HDR_CAP_MODE,
		.seamless_switch_mode_setting_table = klimts5kjn5tele_v2_custom13_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(klimts5kjn5tele_v2_custom13_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 920000000,
	...
	//complete 6 (8->6)  v1.6zzq_0808
	{
		.frame_desc = frame_desc_cus14,
		.num_entries = ARRAY_SIZE(frame_desc_cus14),
		.mode_setting_table = klimts5kjn5tele_v2_custom14_setting,
		.mode_setting_len = ARRAY_SIZE(klimts5kjn5tele_v2_custom14_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_HDR_CAP_MODE,
		.seamless_switch_mode_setting_table = klimts5kjn5tele_v2_custom14_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(klimts5kjn5tele_v2_custom14_setting),
		...
		.fine_integ_line = 0,
		.delay_frame = 2,
		.saturation_info = &klimts5kjn5_v2_saturation_info_12bit,
		.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW12_B,
	},
	//custom15 mode 19: 2exp stagger
	//fake 12bit
	//complete 8 (10->8) v1.6zzq_0808
	{
		.frame_desc = frame_desc_cus15,
		.num_entries = ARRAY_SIZE(frame_desc_cus15),
		.mode_setting_table = klimts5kjn5tele_v2_custom15_setting,
		.mode_setting_len = ARRAY_SIZE(klimts5kjn5tele_v2_custom15_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_HDR_CAP_MODE,
		.seamless_switch_mode_setting_table = klimts5kjn5tele_v2_custom15_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(klimts5kjn5tele_v2_custom15_setting),
	...
	//custom 17 mode 21: 
	//4096x2560
	//complete 9 (11->9) v1.6zzq_0808
	{
		.frame_desc = frame_desc_cus17,
		.num_entries = ARRAY_SIZE(frame_desc_cus17),
		.mode_setting_table = klimts5kjn5tele_v2_custom17_setting,
		.mode_setting_len = ARRAY_SIZE(klimts5kjn5tele_v2_custom17_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_VIDEO_1610_MODE,
		.seamless_switch_mode_setting_table = klimts5kjn5tele_v2_custom17_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(klimts5kjn5tele_v2_custom17_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 920000000,
	...
	//custom 18 mode 22:
	//4096x2560
	//complete 10(12->10) v1.6zzq_0808
	{
		.frame_desc = frame_desc_cus18,
		.num_entries = ARRAY_SIZE(frame_desc_cus18),
		.mode_setting_table = klimts5kjn5tele_v2_custom18_setting,
		.mode_setting_len = ARRAY_SIZE(klimts5kjn5tele_v2_custom18_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_VIDEO_1610_MODE,
		.seamless_switch_mode_setting_table = klimts5kjn5tele_v2_custom18_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(klimts5kjn5tele_v2_custom18_setting),
		.hdr_mode = HDR_RAW_DCG_COMPOSE,
		.raw_cnt = 1,
		.exp_cnt = 2,
		.pclk = 920000000,
	...
	//custom 19 mode 23:
	//4096x2560
	//complete 11 (13->11) v1.6zzq_0808
	{
		.frame_desc = frame_desc_cus19,
		.num_entries = ARRAY_SIZE(frame_desc_cus19),
		.mode_setting_table = klimts5kjn5tele_v2_custom19_setting,
		.mode_setting_len = ARRAY_SIZE(klimts5kjn5tele_v2_custom19_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_VIDEO_1610_MODE,
		.seamless_switch_mode_setting_table = klimts5kjn5tele_v2_custom19_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(klimts5kjn5tele_v2_custom19_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 920000000,
...
static struct subdrv_static_ctx static_ctx = {
	.sensor_id = KLIMTS5KJN5TELE_V2_SENSOR_ID,
	...
	.ana_gain_type = 1,
	.ana_gain_step = 1,
	.ana_gain_table = klimts5kjn5tele_v2_ana_gain_table,
	.ana_gain_table_size = sizeof(klimts5kjn5tele_v2_ana_gain_table),
	.tuning_iso_base = 50,
	.exposure_def = 0x3D0,
	.exposure_min = 4,
	...
	.exposure_step = 2,
	.exposure_margin = 12,
	.saturation_info = &klimts5kjn5_v2_saturation_info_10bit,
...
//	.reg_addr_auto_extend = PARAM_UNDEFINED,
	...
	.init_setting_table = klimts5kjn5tele_v2_init_setting,
	.init_setting_len = ARRAY_SIZE(klimts5kjn5tele_v2_init_setting),
	.mode = mode_struct,
...
static struct subdrv_ops ops = {
	.get_id = klimts5kjn5tele_v2_get_imgsensor_id,
	.init_ctx = init_ctx,
	.open = common_open,
	.get_info = common_get_info,
	.get_resolution = common_get_resolution,
	.control = klimts5kjn5tele_v2_control,
...
const struct subdrv_entry klimts5kjn5tele_v2_mipi_raw_entry = {
	.name = "klimts5kjn5tele_v2_mipi_raw",
	.id = KLIMTS5KJN5TELE_V2_SENSOR_ID,
	.pw_seq = pw_seq,
...
static int klimts5kjn5tele_v2_set_shutter_frame_length(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
	...
	klimts5kjn5tele_v2_set_long_exposure(ctx);
	/* write framelength */
	if (set_auto_flicker(ctx, 0) || frame_length || !ctx->s_ctx.reg_addr_auto_extend)
		klimts5kjn5tele_v2_write_frame_length(ctx, ctx->frame_length);
	else if (ctx->s_ctx.reg_addr_auto_extend)
		klimts5kjn5tele_v2_write_frame_length(ctx, ctx->min_frame_length);
	/* write shutter */
...
static int klimts5kjn5tele_v2_set_shutter(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
	klimts5kjn5tele_v2_set_shutter_frame_length(ctx, para, len);
	return 0;
}

void klimts5kjn5tele_v2_update_mode_info(struct subdrv_ctx *ctx, enum SENSOR_SCENARIO_ID_ENUM scenario_id)
{
	if (scenario_id >= ctx->s_ctx.sensor_mode_num)
	{
		DRV_LOGE(ctx, "invalid sid:%u, mode_num:%u\n",
...
void klimts5kjn5tele_v2_set_multi_shutter_frame_length_dol(struct subdrv_ctx *ctx,
...
void klimts5kjn5tele_v2_write_lens(struct subdrv_ctx *ctx)
{
	u16 len_macro = 0;
	u16 len_inf = 0;
	u8 *pbuf = NULL;
...
static int klimts5kjn5tele_v2_seamless_switch(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
	...
	klimts5kjn5tele_v2_update_mode_info(ctx, scenario_id);
	...
	klimts5kjn5tele_v2_set_awb_gain(ctx, (u8 *)&g_last_awb_gain, &retLen);
	i2c_table_write(ctx,
	...
	if (ae_ctrl) {
		...
		case HDR_RAW_STAGGER:
			klimts5kjn5tele_v2_set_multi_shutter_frame_length_dol(ctx, (u64 *)&ae_ctrl->exposure, exp_cnt, 0);
			set_multi_gain(ctx, (u32 *)&ae_ctrl->gain, exp_cnt);
			break;
		case HDR_RAW_DCG_COMPOSE:
			set_multi_shutter_frame_length(ctx, (u64 *)&ae_ctrl->exposure, 1, 0);
			klimts5kjn5tele_v2_set_gain(ctx, (u8 *)&ae_ctrl->gain.le_gain,len);
			break;
		default:
			klimts5kjn5tele_v2_set_shutter_frame_length(ctx, (u8 *)&ae_ctrl->exposure.le_exposure,len);
	...
	if(ctx->s_ctx.mode[scenario_id].imgsensor_winsize_info.w2_tg_size == 8192)
		klimts5kjn5tele_v2_write_lens(ctx);

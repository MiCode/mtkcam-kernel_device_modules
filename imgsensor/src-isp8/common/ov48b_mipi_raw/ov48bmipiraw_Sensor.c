...
static struct subdrv_mode_struct mode_struct[] = {
	...
	},
	{
		...
		.mode_setting_table = addr_data_pair_custom15,
		.mode_setting_len = ARRAY_SIZE(addr_data_pair_custom15),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	},
	{
		...
		.mode_setting_table = addr_data_pair_custom16,
		.mode_setting_len = ARRAY_SIZE(addr_data_pair_custom16),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	},
	{
		...
		.mode_setting_table = addr_data_pair_custom17,
		.mode_setting_len = ARRAY_SIZE(addr_data_pair_custom17),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	},
	{
		...
		.mode_setting_table = addr_data_pair_custom18,
		.mode_setting_len = ARRAY_SIZE(addr_data_pair_custom18),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	},
	{
		...
		.mode_setting_table = addr_data_pair_custom19,
		.mode_setting_len = ARRAY_SIZE(addr_data_pair_custom19),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
...
static struct subdrv_pw_seq_entry pw_seq[] = {
	...
	{HW_ID_DVDD, {1090000, 1090000}, 5000}, // pmic_ldo for dvdd
	{HW_ID_RST, {1}, 5000},
};

...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info = {
	...
	.i4Crop = {
		...
		{0, 0}, {0, 434}, {0, 0}, {2312, 1736}, {2312, 1736},
		// <cust6> <cust7>
		{0, 0}, {0, 0},
	},
	.iMirrorFlip = 0,
...
// mode 12: 2312*1736@60fps, FHD, non-pd
...
static struct subdrv_mode_struct mode_struct[] = {
	...
	// mode 6: 4624*2604@23fps, stagger 2exp + pd
	{
		...
		.framelength_step = 4*2,
		.multi_exposure_shutter_range[IMGSENSOR_EXPOSURE_ME].max = 2550 *2,
		.multi_exposure_shutter_range[IMGSENSOR_EXPOSURE_LE].max = 0xFFFFF *2,
		.imgsensor_winsize_info = {
			.full_w = 9248,
			.full_h = 6944,
			.x0_offset = 0,
	...
	// mode 12: 2312*1736@60fps, FHD, non-pd
	{
		...
		.mode_setting_table = ov64b_custom8_setting,
		.mode_setting_len = ARRAY_SIZE(ov64b_custom8_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
...
static struct subdrv_pw_seq_entry pw_seq[] = {
	...
	{HW_ID_DVDD, {1100000, 1100000}, 0}, // pmic_ldo/gpio(1.1V ldo) for dvdd
	{HW_ID_DOVDD, {1800000, 1800000}, 1000}, // pmic_ldo/gpio(1.8V ldo) for dovdd
	{HW_ID_OISVDD, {3100000, 3100000}, 0}, // pmic_ldo for oisvdd
	{HW_ID_OISEN, {3100000, 3100000}, 0}, // gpio for oisen

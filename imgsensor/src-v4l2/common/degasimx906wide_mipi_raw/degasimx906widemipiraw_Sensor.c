 ...
 * Filename:
 * ---------
 *	 degasimx906widemipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
 ...
 *============================================================================
 ****************************************************************************/
#include "degasimx906widemipiraw_Sensor.h"
...
static int degasimx906wide_seamless_switch(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int  degasimx906wide_set_test_pattern(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int degasimx906wide_set_multi_dig_gain(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static void degasimx906wide_get_dispatch_gain(struct subdrv_ctx *ctx, u32 tgain, u32 *again, u32 *dgain);
static int degasimx906wide_get_readout_by_scenario(struct subdrv_ctx *ctx, u8 *para, u32 *len);
...
static u32 degasimx906_dcg_ratio_table_12bit[] = {4000};
static u32 degasimx906_dcg_ratio_table_14bit[] = {16000};

static struct mtk_sensor_saturation_info degasimx906_saturation_info_10bit = {
	.gain_ratio = 1000,
	.OB_pedestal = 64,
	.saturation_level = 1023,
};

static struct mtk_sensor_saturation_info degasimx906_saturation_info_12bit = {
	.gain_ratio = 4000,
...
static struct mtk_sensor_saturation_info degasimx906_saturation_info_14bit = {
	.gain_ratio = 16000,
	.OB_pedestal = 64, // Figure 8-77 Saturation level for DAG-HDR
...
static struct mtk_sensor_saturation_info degasimx906_saturation_info_fake12bit = {
	.gain_ratio = 1000,
	.OB_pedestal = 256,
...
static struct mtk_sensor_saturation_info degasimx906_saturation_info_fake14bit = {
	.gain_ratio = 1000,
	.OB_pedestal = 1024,
...
static struct subdrv_feature_control feature_control_list[] = {
	{SENSOR_FEATURE_SET_TEST_PATTERN, degasimx906wide_set_test_pattern},
	{SENSOR_FEATURE_SEAMLESS_SWITCH, degasimx906wide_seamless_switch},
	{SENSOR_FEATURE_SET_MULTI_DIG_GAIN, degasimx906wide_set_multi_dig_gain},
	{SENSOR_FEATURE_GET_READOUT_BY_SCENARIO, degasimx906wide_get_readout_by_scenario},
};
...
static struct subdrv_mode_struct mode_struct[] = {
	...
	// ver8.10-5.00_240312
	{
		...
		.mode_setting_table = degasimx906wide_preview_setting,
		.mode_setting_len = ARRAY_SIZE(degasimx906wide_preview_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_HD_CAP_MODE,
		.seamless_switch_mode_setting_table = degasimx906wide_preview_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(degasimx906wide_preview_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 2196000000,
	...
	// ver8.10-5.00_240312
	{
		...
		.mode_setting_table = degasimx906wide_normal_video_setting,
		.mode_setting_len = ARRAY_SIZE(degasimx906wide_normal_video_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = degasimx906wide_normal_video_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(degasimx906wide_normal_video_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 2196000000,
	...
	// ver8.10-5.00_240312
	{
		...
		.mode_setting_table = degasimx906wide_hs_video_setting,
		.mode_setting_len = ARRAY_SIZE(degasimx906wide_hs_video_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = degasimx906wide_hs_video_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(degasimx906wide_hs_video_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 2196000000,
	...
	// ver9.00-6.00_MP
	{
		...
		.mode_setting_table = degasimx906wide_custom1_setting,
		.mode_setting_len = ARRAY_SIZE(degasimx906wide_custom1_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_HD_CAP_MODE,
		.seamless_switch_mode_setting_table = degasimx906wide_custom1_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(degasimx906wide_custom1_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 2196000000,
		...
		.saturation_info = &degasimx906_saturation_info_fake12bit,
	},
	...
	// ver8.10-5.00_240312
	{
		...
		.mode_setting_table = degasimx906wide_custom2_setting,
		.mode_setting_len = ARRAY_SIZE(degasimx906wide_custom2_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = degasimx906wide_custom2_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(degasimx906wide_custom2_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 2196000000,
	...
	// ver8.10-5.00_240312
	{
		...
		.mode_setting_table = degasimx906wide_custom3_setting,
		.mode_setting_len = ARRAY_SIZE(degasimx906wide_custom3_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = degasimx906wide_custom3_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(degasimx906wide_custom3_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 2196000000,
	...
	// ver8.10-5.00_240312
	{
		...
		.mode_setting_table = degasimx906wide_custom4_setting,
		.mode_setting_len = ARRAY_SIZE(degasimx906wide_custom4_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_HD_CAP_MODE,
		.seamless_switch_mode_setting_table = degasimx906wide_custom4_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(degasimx906wide_custom4_setting),
	...
	// ver8.10-5.00_240312
	{
		...
		.mode_setting_table = degasimx906wide_custom5_setting,
		.mode_setting_len = ARRAY_SIZE(degasimx906wide_custom5_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_NORMAL_CAP_MODE,
		.seamless_switch_mode_setting_table = degasimx906wide_custom5_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(degasimx906wide_custom5_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 2082000000,
		...
		.saturation_info = &degasimx906_saturation_info_fake14bit,
	},
	...
	// ver8.10-5.00_240312
	{
		...
		.mode_setting_table = degasimx906wide_custom18_setting,
		.mode_setting_len = ARRAY_SIZE(degasimx906wide_custom18_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_SUPER_NIGHT_VIDEO,
		.seamless_switch_mode_setting_table = degasimx906wide_custom18_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(degasimx906wide_custom18_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 2196000000,
	...
	// ver8.10-5.00_240312
	{
		...
		.mode_setting_table = degasimx906wide_custom8_setting,
		.mode_setting_len = ARRAY_SIZE(degasimx906wide_custom8_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = degasimx906wide_custom8_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(degasimx906wide_custom8_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 2196000000,
	...
	// ver8.10-5.00_240312
	{
		...
		.mode_setting_table = degasimx906wide_custom9_setting,
		.mode_setting_len = ARRAY_SIZE(degasimx906wide_custom9_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_VIDEO_MODE,
		.seamless_switch_mode_setting_table = degasimx906wide_custom9_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(degasimx906wide_custom9_setting),
		...
		.saturation_info = &degasimx906_saturation_info_14bit,
		.dcg_info = {
			...
			.dcg_gain_table = degasimx906_dcg_ratio_table_14bit,
			.dcg_gain_table_size = sizeof(degasimx906_dcg_ratio_table_14bit),
	...
	// ver8.10-5.00_240312
	{
		...
		.mode_setting_table = degasimx906wide_custom10_setting,
		.mode_setting_len = ARRAY_SIZE(degasimx906wide_custom10_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_NORMAL_CAP_MODE,
		.seamless_switch_mode_setting_table = degasimx906wide_custom10_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(degasimx906wide_custom10_setting),
	...
	// ver8.10-5.00_240312
	{
		...
		.mode_setting_table = degasimx906wide_custom11_setting,
		.mode_setting_len = ARRAY_SIZE(degasimx906wide_custom11_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = degasimx906wide_custom11_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(degasimx906wide_custom11_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 2196000000,
	...
	// ver8.10-5.00_240312
	{
		...
		.mode_setting_table = degasimx906wide_custom12_setting,
		.mode_setting_len = ARRAY_SIZE(degasimx906wide_custom12_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = degasimx906wide_custom12_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(degasimx906wide_custom12_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 2082000000,
	...
	// ver8.10-5.00_240312
	{
		...
		.mode_setting_table = degasimx906wide_custom13_setting,
		.mode_setting_len = ARRAY_SIZE(degasimx906wide_custom13_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_NORMAL_CAP_MODE,
		.seamless_switch_mode_setting_table = degasimx906wide_custom13_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(degasimx906wide_custom13_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 2082000000,
	...
	// ver8.10-5.00_240312
	{
		...
		.mode_setting_table = degasimx906wide_custom14_setting,
		.mode_setting_len = ARRAY_SIZE(degasimx906wide_custom14_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_NORMAL_CAP_MODE,
		.seamless_switch_mode_setting_table = degasimx906wide_custom14_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(degasimx906wide_custom14_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 2082000000,
	...
	// ver9.00-6.00_MP
	{
		...
		.mode_setting_table = degasimx906wide_custom15_setting,
		.mode_setting_len = ARRAY_SIZE(degasimx906wide_custom15_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_NORMAL_CAP_MODE,
		.seamless_switch_mode_setting_table = degasimx906wide_custom15_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(degasimx906wide_custom15_setting),
		.hdr_mode = HDR_RAW_DCG_COMPOSE,
		.raw_cnt = 1,
		.exp_cnt = 2,
		.pclk = 2082000000,
	...
	// ver8.10-5.00_240312
	{
		...
		.mode_setting_table = degasimx906wide_custom16_setting,
		.mode_setting_len = ARRAY_SIZE(degasimx906wide_custom16_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_NORMAL_CAP_MODE,
		.seamless_switch_mode_setting_table = degasimx906wide_custom16_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(degasimx906wide_custom16_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 2082000000,
	...
	// ver8.10-5.00_240312
	{
		...
		.mode_setting_table = degasimx906wide_custom17_setting,
		.mode_setting_len = ARRAY_SIZE(degasimx906wide_custom17_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_VIDEO_MODE,
		.seamless_switch_mode_setting_table = degasimx906wide_custom17_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(degasimx906wide_custom17_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 2196000000,
	...
	// ver8.10-5.00_240312
	{
		...
		.mode_setting_table = degasimx906wide_custom19_setting,
		.mode_setting_len = ARRAY_SIZE(degasimx906wide_custom19_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = degasimx906wide_custom19_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(degasimx906wide_custom19_setting),
		.hdr_mode = PARAM_UNDEFINED,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 2196000000,
	...
	// ver8.10-5.00_240312
	{
		...
		.mode_setting_table = degasimx906wide_custom28_setting,
		.mode_setting_len = ARRAY_SIZE(degasimx906wide_custom28_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_VIDEO_MI_CINELOOK_MODE,
		.seamless_switch_mode_setting_table = degasimx906wide_custom28_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(degasimx906wide_custom28_setting),
		.hdr_mode = HDR_RAW_DCG_COMPOSE,
		.raw_cnt = 1,
		.exp_cnt = 2,
		.pclk = 2196000000,
	...
	// ver8.10-5.00_240312
	{
		...
		.mode_setting_table = degasimx906wide_custom29_setting,
		.mode_setting_len = ARRAY_SIZE(degasimx906wide_custom29_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_VIDEO_MI_CINELOOK_MODE,
		.seamless_switch_mode_setting_table = degasimx906wide_custom29_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(degasimx906wide_custom29_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 2196000000,
	...
	// ver8.10-5.00_240312
	{
		...
		.mode_setting_table = degasimx906wide_custom30_setting,
		.mode_setting_len = ARRAY_SIZE(degasimx906wide_custom30_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_NORMAL_HDR_VIDEO_MODE,
		.seamless_switch_mode_setting_table = degasimx906wide_custom30_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(degasimx906wide_custom30_setting),
		.hdr_mode = HDR_RAW_DCG_COMPOSE,
		.raw_cnt = 1,
		.exp_cnt = 2,
		.pclk = 2196000000,
		...
		.multi_exposure_ana_gain_range[IMGSENSOR_EXPOSURE_ME].min = BASEGAIN * 1.428711f,
		.saturation_info = &degasimx906_saturation_info_12bit,
		.dcg_info = {
			.dcg_mode = IMGSENSOR_DCG_COMPOSE,
			.dcg_gain_mode = IMGSENSOR_DCG_RATIO_MODE,
			...
			.dcg_gain_ratio_step = 0,
			.dcg_gain_table = degasimx906_dcg_ratio_table_12bit,
			.dcg_gain_table_size = sizeof(degasimx906_dcg_ratio_table_12bit),
		},
		.imgsensor_winsize_info = {
			.full_w = 8192,
			.full_h = 6144,
	...
	// ver8.10-5.00_240312
	{
		...
		.mode_setting_table = degasimx906wide_custom31_setting,
		.mode_setting_len = ARRAY_SIZE(degasimx906wide_custom31_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_NORMAL_HDR_VIDEO_MODE,
		.seamless_switch_mode_setting_table = degasimx906wide_custom31_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(degasimx906wide_custom31_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 2196000000,
	...
	// ver8.10-5.00_240312
	{
		...
		.mode_setting_table = degasimx906wide_custom32_setting,
		.mode_setting_len = ARRAY_SIZE(degasimx906wide_custom32_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_NORMAL_HDR_VIDEO_MODE,
		.seamless_switch_mode_setting_table = degasimx906wide_custom32_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(degasimx906wide_custom32_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 2196000000,
	...
	// ver9.00-6.00_MP
	{
		...
		.mode_setting_table = degasimx906wide_custom34_setting,
		.mode_setting_len = ARRAY_SIZE(degasimx906wide_custom34_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_NORMAL_60FPS_HDR_VIDEO_MODE,
		.seamless_switch_mode_setting_table = degasimx906wide_custom34_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(degasimx906wide_custom34_setting),
		.hdr_mode = HDR_RAW_DCG_COMPOSE,
		.raw_cnt = 1,
		.exp_cnt = 2,
		.pclk = 2196000000,
	...
	// ver9.00-6.00_MP
	{
		...
		.mode_setting_table = degasimx906wide_custom35_setting,
		.mode_setting_len = ARRAY_SIZE(degasimx906wide_custom35_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_NORMAL_60FPS_HDR_VIDEO_MODE,
		.seamless_switch_mode_setting_table = degasimx906wide_custom35_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(degasimx906wide_custom35_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 2196000000,
...
static struct subdrv_static_ctx static_ctx = {
	.sensor_id = DEGASIMX906WIDE_SENSOR_ID,
	...
	.ana_gain_type = 0,
	.ana_gain_step = 1,
	.ana_gain_table = degasimx906wide_ana_gain_table,
	.ana_gain_table_size = sizeof(degasimx906wide_ana_gain_table),
	.min_gain_iso = 50,
	.exposure_def = 0x3D0,
	.exposure_min = 6,
	...
	.exposure_step = 2,
	.exposure_margin = 48,
	.saturation_info = &degasimx906_saturation_info_10bit,
	...
	.init_setting_table = degasimx906wide_init_setting,
	.init_setting_len = ARRAY_SIZE(degasimx906wide_init_setting),
	.mode = mode_struct,
...
const struct subdrv_entry degasimx906wide_mipi_raw_entry = {
	.name = SENSOR_DRVNAME_DEGASIMX906WIDE_MIPI_RAW,
	.id = DEGASIMX906WIDE_SENSOR_ID,
	.pw_seq = pw_seq,
	...
	if (ae_ctrl) {
		...
		case HDR_RAW_DCG_COMPOSE:
			...
			if (ctx->s_ctx.mode[scenario_id].dcg_info.dcg_gain_mode
				...
				degasimx906wide_get_dispatch_gain(ctx, tgain, again, dgain);
				feature_para[0] = (u64)dgain;
				feature_para[1] = 1;
				degasimx906wide_set_multi_dig_gain(ctx, (u8 *)feature_para, &retLen);

 ...
 * Filename:
 * ---------
 *	 degasov13b10ultramipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
 ...
 *============================================================================
 ****************************************************************************/
#include "degasov13b10ultramipiraw_Sensor.h"

static void set_group_hold(void *arg, u8 en);
static void degasov13b10ultra_set_dummy(struct subdrv_ctx *ctx);
static int degasov13b10ultra_set_max_framerate_by_scenario(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static u16 get_gain2reg(u32 gain);
static int  degasov13b10ultra_set_test_pattern(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int init_ctx(struct subdrv_ctx *ctx,	struct i2c_client *i2c_client, u8 i2c_write_id);
static int ultra_vsync_notify(struct subdrv_ctx *ctx, unsigned int sof_cnt);
static int degasov13b10ultra_set_shutter_frame_length(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int degasov13b10ultra_set_shutter(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int degasov13b10ultra_set_multi_shutter_frame_length(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int degasov13b10ultra_set_multi_dig_gain(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int degasov13b10ultra_get_csi_param(struct subdrv_ctx *ctx, enum SENSOR_SCENARIO_ID_ENUM scenario_id, struct mtk_csi_param *csi_param);

/* STRUCT */
static struct subdrv_feature_control feature_control_list[] = {
	{SENSOR_FEATURE_SET_TEST_PATTERN, degasov13b10ultra_set_test_pattern},
	{SENSOR_FEATURE_SET_MAX_FRAME_RATE_BY_SCENARIO, degasov13b10ultra_set_max_framerate_by_scenario},
	{SENSOR_FEATURE_SET_ESHUTTER, degasov13b10ultra_set_shutter},
	{SENSOR_FEATURE_SET_SHUTTER_FRAME_TIME, degasov13b10ultra_set_shutter_frame_length},
	{SENSOR_FEATURE_SET_MULTI_SHUTTER_FRAME_TIME, degasov13b10ultra_set_multi_shutter_frame_length},
	{SENSOR_FEATURE_SET_MULTI_DIG_GAIN, degasov13b10ultra_set_multi_dig_gain}
};
...
{\
	...
	.mode_setting_table = degasov13b10ultra_preview_setting,\
	.mode_setting_len = ARRAY_SIZE(degasov13b10ultra_preview_setting),\
...
{\
	...
	.mode_setting_table = degasov13b10ultra_normal_video_setting,\
	.mode_setting_len = ARRAY_SIZE(degasov13b10ultra_normal_video_setting),\
	.seamless_switch_group = PARAM_UNDEFINED,\
	.seamless_switch_mode_setting_table = PARAM_UNDEFINED,\
	.seamless_switch_mode_setting_len = PARAM_UNDEFINED,\
	.hdr_mode = HDR_NONE,\
...
{\
	...
	.mode_setting_table = degasov13b10ultra_custom1_setting,\
	.mode_setting_len = ARRAY_SIZE(degasov13b10ultra_custom1_setting),\
	.seamless_switch_group = PARAM_UNDEFINED,\
	.seamless_switch_mode_setting_table = PARAM_UNDEFINED,\
	.seamless_switch_mode_setting_len = PARAM_UNDEFINED,\
	.hdr_mode = HDR_NONE,\
...
{\
	...
	.mode_setting_table = degasov13b10ultra_custom2_setting,\
	.mode_setting_len = ARRAY_SIZE(degasov13b10ultra_custom2_setting),\
	.seamless_switch_group = PARAM_UNDEFINED,\
	.seamless_switch_mode_setting_table = PARAM_UNDEFINED,\
	.seamless_switch_mode_setting_len = PARAM_UNDEFINED,\
	.hdr_mode = HDR_NONE,\
...
static struct subdrv_static_ctx static_ctx = {
	.sensor_id = DEGASOV13B10ULTRA_SENSOR_ID,
	...
	.ana_gain_type = 1,
	.ana_gain_step = 1,
	.ana_gain_table = degasov13b10ultra_ana_gain_table,
	.ana_gain_table_size = sizeof(degasov13b10ultra_ana_gain_table),
	.min_gain_iso = 50,
	.exposure_def = 0x3D0,
	.exposure_min = 4,
	...
	.init_setting_table = degasov13b10ultra_init_setting,
	.init_setting_len = ARRAY_SIZE(degasov13b10ultra_init_setting),
	.mode = mode_struct,
...
static struct subdrv_ops ops = {
	...
	.get_csi_param = degasov13b10ultra_get_csi_param,
...
const struct subdrv_entry degasov13b10ultra_mipi_raw_entry = {
	.name = "degasov13b10ultra_mipi_raw",
	.id = DEGASOV13B10ULTRA_SENSOR_ID,
	.pw_seq = pw_seq,
...
static int degasov13b10ultra_set_max_framerate_by_scenario(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
	...
	if (ctx->frame_length > (ctx->exposure[0] + ctx->s_ctx.exposure_margin))
		degasov13b10ultra_set_dummy(ctx);
...
static int degasov13b10ultra_set_shutter(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
	degasov13b10ultra_set_shutter_frame_length(ctx, para, len);
	return 0;
}
static int degasov13b10ultra_set_multi_shutter_frame_length(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
...
static int degasov13b10ultra_get_csi_param(struct subdrv_ctx *ctx,

 ...
 * Filename:
 * ---------
 *     DEGASS5KKD1FRONTmipiraw_Sensor.c
 *
 * Project:
 * --------
 *     ALPS
 ...
 *============================================================================
 ****************************************************************************/
#include "degass5kkd1frontmipiraw_Sensor.h"
#include <linux/timer.h>
#include "adaptor-ctrls.h"

#define DEBUG_LOG_EN 0
#define PFX "DEGASS5KKD1FRONT_camera_sensor"
...
static int degass5kkd1front_set_test_pattern(struct subdrv_ctx *ctx, u8 *para, u32 *len);
...
static struct subdrv_feature_control feature_control_list[] = {
	{
		...
		.func = degass5kkd1front_set_test_pattern
	},
};
...
static struct subdrv_mode_struct mode_struct[] = {
	{	/* mode 0 : preview 3280x2464@30fps */
		.mode_setting_table = degass5kkd1front_preview_setting,
		.mode_setting_len = ARRAY_SIZE(degass5kkd1front_preview_setting),
	...
	{	/* mode 2 : normal video 3280x1848@30fps */
		.mode_setting_table = degass5kkd1front_normal_video_setting,
		.mode_setting_len = ARRAY_SIZE(degass5kkd1front_normal_video_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	{	/* mode : 3 hs_video 1080p@120fps */
		.mode_setting_table = degass5kkd1front_hs_video_setting,
		.mode_setting_len = ARRAY_SIZE(degass5kkd1front_hs_video_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	{	/* mode 5 : video 60fps 3280x1848@60FPS */
		.mode_setting_table = degass5kkd1front_custom1_setting,
		.mode_setting_len = ARRAY_SIZE(degass5kkd1front_custom1_setting),
	...
	{	/* mode : 6  640x480@10FPS */
		.mode_setting_table = degass5kkd1front_custom2_setting,
		.mode_setting_len = ARRAY_SIZE(degass5kkd1front_custom2_setting),
		.mode_setting_table_for_md = degass5kkd1front_md1_setting,
		.mode_setting_len_for_md = ARRAY_SIZE(degass5kkd1front_md1_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	{	/* mode : 7  408x308@10FPS */
		.mode_setting_table = degass5kkd1front_custom3_setting,
		.mode_setting_len = ARRAY_SIZE(degass5kkd1front_custom3_setting),
		.mode_setting_table_for_md = degass5kkd1front_md1_setting,
		.mode_setting_len_for_md = ARRAY_SIZE(degass5kkd1front_md1_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
...
static struct subdrv_static_ctx static_ctx = {
	.sensor_id = DEGASS5KKD1FRONT_SENSOR_ID,
	...
	.ana_gain_type = 2,
	.ana_gain_step = 32,
	.ana_gain_table = degass5kkd1front_ana_gain_table,
	.ana_gain_table_size = sizeof(degass5kkd1front_ana_gain_table),
	.min_gain_iso = 50,
	.exposure_def = 0x3D0,
	.exposure_min = 5,
	...
	.init_setting_table = degass5kkd1front_init_setting,
	.init_setting_len = ARRAY_SIZE(degass5kkd1front_init_setting),
	.mode = mode_struct,
...
const struct subdrv_entry degass5kkd1front_mipi_raw_entry = {
	.name = "degass5kkd1front_mipi_raw",
	.id = DEGASS5KKD1FRONT_SENSOR_ID,
	.pw_seq = pw_seq,

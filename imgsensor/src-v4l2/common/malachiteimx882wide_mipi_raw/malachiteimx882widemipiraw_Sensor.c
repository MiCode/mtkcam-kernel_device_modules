 ...
 * Filename:
 * ---------
 *	 malachiteimx882widemipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
 ...
 *============================================================================
 ****************************************************************************/
#include "malachiteimx882widemipiraw_Sensor.h"

static void set_sensor_cali(void *arg);
static int get_sensor_temperature(void *arg);
static void set_group_hold(void *arg, u8 en);
static u16 get_gain2reg(u32 gain);
static int malachiteimx882wide_seamless_switch(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int malachiteimx882wide_set_test_pattern(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int malachiteimx882wide_set_shutter(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int malachiteimx882wide_set_shutter_frame_length(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int init_ctx(struct subdrv_ctx *ctx, struct i2c_client *i2c_client, u8 i2c_write_id);
static int vsync_notify(struct subdrv_ctx *ctx,	unsigned int sof_cnt);
static int malachiteimx882wide_set_awb_gain(struct subdrv_ctx *ctx, u8 *para, u32 *len);
...
static struct subdrv_feature_control feature_control_list[] = {
	{SENSOR_FEATURE_SET_TEST_PATTERN, malachiteimx882wide_set_test_pattern},
	{SENSOR_FEATURE_SEAMLESS_SWITCH, malachiteimx882wide_seamless_switch},
	{SENSOR_FEATURE_SET_ESHUTTER, malachiteimx882wide_set_shutter},
	{SENSOR_FEATURE_SET_SHUTTER_FRAME_TIME, malachiteimx882wide_set_shutter_frame_length},
	{SENSOR_FEATURE_SET_AWB_GAIN, malachiteimx882wide_set_awb_gain},
};
...
static struct subdrv_mode_struct mode_struct[] = {
	{
		...
		.mode_setting_table = malachiteimx882wide_preview_setting,
		.mode_setting_len = ARRAY_SIZE(malachiteimx882wide_preview_setting),
		.seamless_switch_group = 1,
		.seamless_switch_mode_setting_table = malachiteimx882wide_seamless_preview,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(malachiteimx882wide_seamless_preview),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 876800000,
	...
	},
	{
		...
		.mode_setting_table = malachiteimx882wide_capture_setting,
		.mode_setting_len = ARRAY_SIZE(malachiteimx882wide_capture_setting),
	...
	},
	{
		...
		.mode_setting_table = malachiteimx882wide_normal_video_setting,
		.mode_setting_len = ARRAY_SIZE(malachiteimx882wide_normal_video_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	},
	{
		...
		.mode_setting_table = malachiteimx882wide_hs_video_setting,
		.mode_setting_len = ARRAY_SIZE(malachiteimx882wide_hs_video_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	},
	{
		...
		.mode_setting_table = malachiteimx882wide_slim_video_setting,
		.mode_setting_len = ARRAY_SIZE(malachiteimx882wide_slim_video_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	},
	{
		...
		.mode_setting_table = malachiteimx882wide_custom1_setting,
		.mode_setting_len = ARRAY_SIZE(malachiteimx882wide_custom1_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	},
	{
		...
		.mode_setting_table = malachiteimx882wide_custom2_setting,
		.mode_setting_len = ARRAY_SIZE(malachiteimx882wide_custom2_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	},
	{
		...
		.mode_setting_table = malachiteimx882wide_custom3_setting,
		.mode_setting_len = ARRAY_SIZE(malachiteimx882wide_custom3_setting),
		.seamless_switch_group = 1,
		.seamless_switch_mode_setting_table = malachiteimx882wide_seamless_custom3,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(malachiteimx882wide_seamless_custom3),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 876800000,
	...
	},
	{
		...
		.mode_setting_table = malachiteimx882wide_custom4_setting,
		.mode_setting_len = ARRAY_SIZE(malachiteimx882wide_custom4_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	},
	{
		...
		.mode_setting_table = malachiteimx882wide_custom5_setting,
		.mode_setting_len = ARRAY_SIZE(malachiteimx882wide_custom5_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	},
	{
		...
		.mode_setting_table = malachiteimx882wide_custom6_setting,
		.mode_setting_len = ARRAY_SIZE(malachiteimx882wide_custom6_setting),
		.seamless_switch_group = 1,
		.seamless_switch_mode_setting_table = malachiteimx882wide_seamless_custom6,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(malachiteimx882wide_seamless_custom6),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 876800000,
...
static struct subdrv_static_ctx static_ctx = {
	.sensor_id = MALACHITEIMX882WIDE_SENSOR_ID,
	...
	.ana_gain_type = 0,
	.ana_gain_step = 1,
	.ana_gain_table = malachiteimx882wide_ana_gain_table,
	.ana_gain_table_size = sizeof(malachiteimx882wide_ana_gain_table),
	.min_gain_iso = 50,
	.exposure_def = 0x3D0,
	.exposure_min = 6,
	...
	.init_setting_table = malachiteimx882wide_init_setting,
	.init_setting_len = ARRAY_SIZE(malachiteimx882wide_init_setting),
	.mode = mode_struct,
...
static struct subdrv_pw_seq_entry pw_seq[] = {
	...
	{HW_ID_DVDD1, 1100000, 1},
	{HW_ID_RST, 1, 5}
};

const struct subdrv_entry malachiteimx882wide_mipi_raw_entry = {
	.name = "malachiteimx882wide_mipi_raw",
	.id = MALACHITEIMX882WIDE_SENSOR_ID,
	.pw_seq = pw_seq,
...
static int malachiteimx882wide_seamless_switch(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
	...
	if (ae_ctrl) {
		...
		case HDR_RAW_STAGGER:
			...
			break;
		default:
			malachiteimx882wide_set_shutter(ctx, (u8 *)(&ae_ctrl->exposure.le_exposure), len); //use sensor's set_shutter
...
static int malachiteimx882wide_set_shutter(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
	malachiteimx882wide_set_shutter_frame_length(ctx, para, len);
	return 0;
}

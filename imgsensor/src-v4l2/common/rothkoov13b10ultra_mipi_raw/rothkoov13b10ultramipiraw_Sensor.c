 ...
 * Filename:
 * ---------
 *	 rothkoov13b10ultramipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
 ...
 *============================================================================
 ****************************************************************************/
#include "rothkoov13b10ultramipiraw_Sensor.h"

static void set_group_hold(void *arg, u8 en);
static void rothkoov13b10ultra_set_dummy(struct subdrv_ctx *ctx);
static int rothkoov13b10ultra_set_max_framerate_by_scenario(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static u16 get_gain2reg(u32 gain);
static int  rothkoov13b10ultra_set_test_pattern(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int init_ctx(struct subdrv_ctx *ctx,	struct i2c_client *i2c_client, u8 i2c_write_id);
static int ultra_vsync_notify(struct subdrv_ctx *ctx, unsigned int sof_cnt);
static int rothkoov13b10ultra_set_shutter_frame_length(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int rothkoov13b10ultra_set_shutter(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int rothkoov13b10ultra_set_multi_shutter_frame_length(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int rothkoov13b10ultra_set_multi_dig_gain(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int rothkoov13b10ultra_get_csi_param(struct subdrv_ctx *ctx, enum SENSOR_SCENARIO_ID_ENUM scenario_id, struct mtk_csi_param *csi_param);

/* STRUCT */
static struct subdrv_feature_control feature_control_list[] = {
	{SENSOR_FEATURE_SET_TEST_PATTERN, rothkoov13b10ultra_set_test_pattern},
	{SENSOR_FEATURE_SET_MAX_FRAME_RATE_BY_SCENARIO, rothkoov13b10ultra_set_max_framerate_by_scenario},
	{SENSOR_FEATURE_SET_ESHUTTER, rothkoov13b10ultra_set_shutter},
	{SENSOR_FEATURE_SET_SHUTTER_FRAME_TIME, rothkoov13b10ultra_set_shutter_frame_length},
	{SENSOR_FEATURE_SET_MULTI_SHUTTER_FRAME_TIME, rothkoov13b10ultra_set_multi_shutter_frame_length},
	{SENSOR_FEATURE_SET_MULTI_DIG_GAIN, rothkoov13b10ultra_set_multi_dig_gain}
};
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info =
{
	...
	.i4Crop = {
		{0, 0}, {0, 0}, {0, 372}, {0, 0}, {0, 0}, {0, 0}, {208, 156}, {208, 156}
	},
...
{\
	...
	.mode_setting_table = rothkoov13b10ultra_preview_setting,\
	.mode_setting_len = ARRAY_SIZE(rothkoov13b10ultra_preview_setting),\
...
{\
	...
	.mode_setting_table = rothkoov13b10ultra_normal_video_setting,\
	.mode_setting_len = ARRAY_SIZE(rothkoov13b10ultra_normal_video_setting),\
	.seamless_switch_group = PARAM_UNDEFINED,\
	.seamless_switch_mode_setting_table = PARAM_UNDEFINED,\
	.seamless_switch_mode_setting_len = PARAM_UNDEFINED,\
	.hdr_mode = HDR_NONE,\
...
{\
	...
	.mode_setting_table = rothkoov13b10ultra_custom1_setting,\
	.mode_setting_len = ARRAY_SIZE(rothkoov13b10ultra_custom1_setting),\
	.seamless_switch_group = PARAM_UNDEFINED,\
	.seamless_switch_mode_setting_table = PARAM_UNDEFINED,\
	.seamless_switch_mode_setting_len = PARAM_UNDEFINED,\
	.hdr_mode = HDR_NONE,\
...
{\
	...
	.mode_setting_table = rothkoov13b10ultra_custom2_setting,\
	.mode_setting_len = ARRAY_SIZE(rothkoov13b10ultra_custom2_setting),\
	.seamless_switch_group = PARAM_UNDEFINED,\
	.seamless_switch_mode_setting_table = PARAM_UNDEFINED,\
	.seamless_switch_mode_setting_len = PARAM_UNDEFINED,\
	.hdr_mode = HDR_NONE,\
...
static struct subdrv_static_ctx static_ctx = {
	.sensor_id = ROTHKOOV13B10ULTRA_SENSOR_ID,
	...
	.ana_gain_type = 1,
	.ana_gain_step = 1,
	.ana_gain_table = rothkoov13b10ultra_ana_gain_table,
	.ana_gain_table_size = sizeof(rothkoov13b10ultra_ana_gain_table),
	.min_gain_iso = 50,
	.exposure_def = 0x3D0,
	.exposure_min = 4,
	...
	.init_setting_table = rothkoov13b10ultra_init_setting,
	.init_setting_len = ARRAY_SIZE(rothkoov13b10ultra_init_setting),
	.mode = mode_struct,
...
static struct subdrv_ops ops = {
	...
	.get_csi_param = rothkoov13b10ultra_get_csi_param,
...
static struct subdrv_pw_seq_entry pw_seq[] = {
	{HW_ID_RST,    0,		1},
	{HW_ID_AVDD1,  2800000, 2},
	{HW_ID_DVDD2,  1800000, 1},//dovdd
	{HW_ID_DVDD,   1800000, 1},//dvdd vcam ldo
...
const struct subdrv_entry rothkoov13b10ultra_mipi_raw_entry = {
	.name = "rothkoov13b10ultra_mipi_raw",
	.id = ROTHKOOV13B10ULTRA_SENSOR_ID,
	.pw_seq = pw_seq,
...
static int rothkoov13b10ultra_set_max_framerate_by_scenario(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
	...
	if (ctx->frame_length > (ctx->exposure[0] + ctx->s_ctx.exposure_margin))
		rothkoov13b10ultra_set_dummy(ctx);
...
static int rothkoov13b10ultra_set_shutter(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
	rothkoov13b10ultra_set_shutter_frame_length(ctx, para, len);
	return 0;
}
static int rothkoov13b10ultra_set_multi_shutter_frame_length(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
...
static int rothkoov13b10ultra_get_csi_param(struct subdrv_ctx *ctx,

 ...
 * Filename:
 * ---------
 *     ROTHKOOV20BFRONTmipiraw_Sensor.c
 *
 * Project:
 * --------
 *     ALPS
 ...
 *============================================================================
 ****************************************************************************/
#include "rothkoov20bfrontmipiraw_Sensor.h"


#define DEBUG_LOG_EN 0
#define PFX "ROTHKOOV20BFRONT_camera_sensor"
...
static int rothkoov20bfront_set_test_pattern(struct subdrv_ctx *ctx, u8 *para, u32 *len);
...
static struct subdrv_feature_control feature_control_list[] = {
	{
		...
		.func = rothkoov20bfront_set_test_pattern
	},
};
...
static struct subdrv_mode_struct mode_struct[] = {
	{	/* mode 0 : preview 2592x1944@30fps */
		.mode_setting_table = rothkoov20bfront_preview_setting,
		.mode_setting_len = ARRAY_SIZE(rothkoov20bfront_preview_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 50000000,
	...
	{	/* mode 2 : normal video 2560x1440@30fps */
		.mode_setting_table = rothkoov20bfront_normal_video_setting,
		.mode_setting_len = ARRAY_SIZE(rothkoov20bfront_normal_video_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 50000000,
	...
	{	/* mode : 3 hs_video 720p@120fps */
		.mode_setting_table = rothkoov20bfront_hs_video_setting,
		.mode_setting_len = ARRAY_SIZE(rothkoov20bfront_hs_video_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 50000000,
	...
	{	/* mode 5 : video 60fps 2560x1440@60FPS */
		.mode_setting_table = rothkoov20bfront_custom1_setting,
		.mode_setting_len = ARRAY_SIZE(rothkoov20bfront_custom1_setting),
	...
	{	/* mode : 6  640x480@10FPS */
		.mode_setting_table = rothkoov20bfront_custom2_setting,
		.mode_setting_len = ARRAY_SIZE(rothkoov20bfront_custom2_setting),
		.mode_setting_table_for_md = rothkoov20bfront_md1_setting,
		.mode_setting_len_for_md = ARRAY_SIZE(rothkoov20bfront_md1_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 50000000,
	...
	{	/* mode : 7  640x480@20FPS */
		.mode_setting_table = rothkoov20bfront_custom3_setting,
		.mode_setting_len = ARRAY_SIZE(rothkoov20bfront_custom3_setting),
		.mode_setting_table_for_md = rothkoov20bfront_md1_setting,
		.mode_setting_len_for_md = ARRAY_SIZE(rothkoov20bfront_md1_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
...
static struct subdrv_static_ctx static_ctx = {
	.sensor_id = ROTHKOOV20BFRONT_SENSOR_ID,
	...
	.ana_gain_type = 1,
	.ana_gain_step = 64,
	.ana_gain_table = rothkoov20bfront_ana_gain_table,
	.ana_gain_table_size = sizeof(rothkoov20bfront_ana_gain_table),
	.min_gain_iso = 50,
	.exposure_def = 0x3D0,
	.exposure_min = 2,
	...
	.init_setting_table = rothkoov20bfront_init_setting,
	.init_setting_len = ARRAY_SIZE(rothkoov20bfront_init_setting),
	.mode = mode_struct,
...
const struct subdrv_entry rothkoov20bfront_mipi_raw_entry = {
	.name = "rothkoov20bfront_mipi_raw",
	.id = ROTHKOOV20BFRONT_SENSOR_ID,
	.pw_seq = pw_seq,

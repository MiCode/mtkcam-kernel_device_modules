 ...
 * Filename:
 * ---------
 *	 rothkos5kjn1telemipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
 ...
 *============================================================================
 ****************************************************************************/
#include "rothkos5kjn1telemipiraw_Sensor.h"

static int get_sensor_temperature(void *arg);
static void set_group_hold(void *arg, u8 en);
static void rothkos5kjn1tele_set_dummy(struct subdrv_ctx *ctx);
static int rothkos5kjn1tele_set_max_framerate_by_scenario(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static u16 get_gain2reg(u32 gain);
static int  rothkos5kjn1tele_set_test_pattern(struct subdrv_ctx *ctx, u8 *para, u32 *len);
...
static struct subdrv_feature_control feature_control_list[] = {
	{SENSOR_FEATURE_SET_TEST_PATTERN, rothkos5kjn1tele_set_test_pattern},
	{SENSOR_FEATURE_SET_MAX_FRAME_RATE_BY_SCENARIO, rothkos5kjn1tele_set_max_framerate_by_scenario},
};
...
static struct subdrv_mode_struct mode_struct[] = {
	// mode 0: 4080x3072@30fps, normal preview +  pd
	{
		...
		.mode_setting_table = rothkos5kjn1tele_preview_setting,
		.mode_setting_len = ARRAY_SIZE(rothkos5kjn1tele_preview_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_NORMAL_CAP_MODE,
		.seamless_switch_mode_setting_table = rothkos5kjn1tele_preview_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(rothkos5kjn1tele_preview_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 560000000,
	...
	// mode 2: 4080x2296@30fps, noraml video + pd
	{
		...
		.mode_setting_table = rothkos5kjn1tele_normal_video_setting,
		.mode_setting_len = ARRAY_SIZE(rothkos5kjn1tele_normal_video_setting),
	...
	// mode 3: 1920x1080@240fps, SMVR + pd,
	{
		.frame_desc = frame_desc_hs_vid,
		.num_entries = ARRAY_SIZE(frame_desc_hs_vid),
		.mode_setting_table = rothkos5kjn1tele_hs_video_setting,
		.mode_setting_len = ARRAY_SIZE(rothkos5kjn1tele_hs_video_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	// mode 5: 3840x2160@60fps, VHDR(m-stream)/ 60fps video + pd
	{
		...
		.mode_setting_table = rothkos5kjn1tele_custom1_setting,
		.mode_setting_len = ARRAY_SIZE(rothkos5kjn1tele_custom1_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	// mode 8 custom4: 8160x6144@10fps sw remosaic + non-pd
	{
		...
		.mode_setting_table = rothkos5kjn1tele_custom4_setting,
		.mode_setting_len = ARRAY_SIZE(rothkos5kjn1tele_custom4_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_NORMAL_CAP_MODE,
		.seamless_switch_mode_setting_table = rothkos5kjn1tele_custom4_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(rothkos5kjn1tele_custom4_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 560000000,
	...
	// mode 9 custom5:fullsize quad bayer crop
	{
		...
		.mode_setting_table = rothkos5kjn1tele_custom5_setting,
		.mode_setting_len = ARRAY_SIZE(rothkos5kjn1tele_custom5_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = rothkos5kjn1tele_custom5_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(rothkos5kjn1tele_custom5_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 560000000,
	...
	// mode 12 custom8: 24fps bokeh leica
	{
		.frame_desc = frame_desc_prev,
		.num_entries = ARRAY_SIZE(frame_desc_prev),
		.mode_setting_table = rothkos5kjn1tele_preview_setting,
...
static struct subdrv_static_ctx static_ctx = {
	.sensor_id = ROTHKOS5KJN1TELE_SENSOR_ID,
	...
	.ana_gain_type = 1,
	.ana_gain_step = 1,
	.ana_gain_table = rothkos5kjn1tele_ana_gain_table,
	.ana_gain_table_size = sizeof(rothkos5kjn1tele_ana_gain_table),
	.min_gain_iso = 50,
	.exposure_def = 0x3D0,
	.exposure_min = 6,
...
//	.reg_addr_auto_extend = PARAM_UNDEFINED,
	...
	.init_setting_table = rothkos5kjn1tele_init_setting,
	.init_setting_len = ARRAY_SIZE(rothkos5kjn1tele_init_setting),
	.mode = mode_struct,
...
static struct subdrv_pw_seq_entry pw_seq[] = {
	{HW_ID_RST,   0,       0},
	{HW_ID_DVDD, 1800000, 1}, // vcam_ldo
	{HW_ID_AFVDD, 2800000, 3},
	{HW_ID_DOVDD, 1800000, 1},
	{HW_ID_DVDD2,  1100000, 1},
...
const struct subdrv_entry rothkos5kjn1tele_mipi_raw_entry = {
	.name = "rothkos5kjn1tele_mipi_raw",
	.id = ROTHKOS5KJN1TELE_SENSOR_ID,
	.pw_seq = pw_seq,
...
static int rothkos5kjn1tele_set_max_framerate_by_scenario(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
	...
	if (ctx->frame_length > (ctx->exposure[0] + ctx->s_ctx.exposure_margin))
		rothkos5kjn1tele_set_dummy(ctx);

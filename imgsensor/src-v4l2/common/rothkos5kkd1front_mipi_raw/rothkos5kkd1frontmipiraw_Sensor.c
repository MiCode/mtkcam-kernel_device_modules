 ...
 * Filename:
 * ---------
 *     ROTHKOS5KKD1FRONTmipiraw_Sensor.c
 *
 * Project:
 * --------
 *     ALPS
 ...
 *============================================================================
 ****************************************************************************/
#include "rothkos5kkd1frontmipiraw_Sensor.h"
#include <linux/timer.h>
#include "adaptor-ctrls.h"

#define DEBUG_LOG_EN 0
#define PFX "ROTHKOS5KKD1FRONT_camera_sensor"
...
static int rothkos5kkd1front_set_test_pattern(struct subdrv_ctx *ctx, u8 *para, u32 *len);
...
static struct subdrv_feature_control feature_control_list[] = {
	{
		...
		.func = rothkos5kkd1front_set_test_pattern
	},
};
...
static struct subdrv_mode_struct mode_struct[] = {
	{	/* mode 0 : preview 3280x2464@30fps */
		.mode_setting_table = rothkos5kkd1front_preview_setting,
		.mode_setting_len = ARRAY_SIZE(rothkos5kkd1front_preview_setting),
	...
	{	/* mode 2 : normal video 3280x1848@30fps */
		.mode_setting_table = rothkos5kkd1front_normal_video_setting,
		.mode_setting_len = ARRAY_SIZE(rothkos5kkd1front_normal_video_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	{	/* mode : 3 hs_video 1080p@120fps */
		.mode_setting_table = rothkos5kkd1front_hs_video_setting,
		.mode_setting_len = ARRAY_SIZE(rothkos5kkd1front_hs_video_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	{	/* mode 5 : video 60fps 3280x1848@60FPS */
		.mode_setting_table = rothkos5kkd1front_custom1_setting,
		.mode_setting_len = ARRAY_SIZE(rothkos5kkd1front_custom1_setting),
	...
	{	/* mode : 6  640x480@10FPS */
		.mode_setting_table = rothkos5kkd1front_custom2_setting,
		.mode_setting_len = ARRAY_SIZE(rothkos5kkd1front_custom2_setting),
		.mode_setting_table_for_md = rothkos5kkd1front_md1_setting,
		.mode_setting_len_for_md = ARRAY_SIZE(rothkos5kkd1front_md1_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	{	/* mode : 7  640x480@20FPS */
		.mode_setting_table = rothkos5kkd1front_custom3_setting,
		.mode_setting_len = ARRAY_SIZE(rothkos5kkd1front_custom3_setting),
		.mode_setting_table_for_md = rothkos5kkd1front_md1_setting,
		.mode_setting_len_for_md = ARRAY_SIZE(rothkos5kkd1front_md1_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
...
static struct subdrv_static_ctx static_ctx = {
	.sensor_id = ROTHKOS5KKD1FRONT_SENSOR_ID,
	...
	.ana_gain_type = 2,
	.ana_gain_step = 32,
	.ana_gain_table = rothkos5kkd1front_ana_gain_table,
	.ana_gain_table_size = sizeof(rothkos5kkd1front_ana_gain_table),
	.min_gain_iso = 50,
	.exposure_def = 0x3D0,
	.exposure_min = 5,
	...
	.init_setting_table = rothkos5kkd1front_init_setting,
	.init_setting_len = ARRAY_SIZE(rothkos5kkd1front_init_setting),
	.mode = mode_struct,
...
static struct subdrv_pw_seq_entry pw_seq[] = {
	...
	{HW_ID_DVDD1, 1800000, 0},
	{HW_ID_RST, 0, 1},
	{HW_ID_DVDD, 1050000, 3},
	{HW_ID_AVDD, 2800000, 3},
	{HW_ID_RST, 1, 4},
	{HW_ID_MCLK1, 26, 0},
	{HW_ID_MCLK1_DRIVING_CURRENT, 6, 8}
};


const struct subdrv_entry rothkos5kkd1front_mipi_raw_entry = {
	.name = "rothkos5kkd1front_mipi_raw",
	.id = ROTHKOS5KKD1FRONT_SENSOR_ID,
	.pw_seq = pw_seq,
 ...
 static void set_mi_init_setting_seq(void *arg)
{
	...
	subdrv_i2c_wr_u16(ctx, 0x0000, 0x0005);
	subdrv_i2c_wr_u16(ctx, 0x0000, 0x4841);
...
static int set_streaming_control(void *arg, bool enable)
{
	...
	if (enable) {
		...
		if (ctx->s_ctx.custom_stream_ctrl_delay &&
			...
			stream_ctrl_delay = (u64)get_sof_timeout(_adaptor_ctx, _adaptor_ctx->cur_mode) / 1000 + ctx->s_ctx.custom_stream_ctrl_delay;
			DRV_LOG_MUST(ctx,

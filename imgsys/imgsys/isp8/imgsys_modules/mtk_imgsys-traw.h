...
#define TRAW_CTL_DBG_SEL	 (0x0210)
#define TRAW_CTL_DBG_PORT	 (0x0214)
#define TRAW_TDR_DBG_SEL	 (0x0210)
#define TRAW_TDR_DBG_PORT	 (0x0214)
#define TRAW_DIPCQ_CQ_EN	 (0x0400)
#define DRZH2N_T1_DBG_SEL	 (0xB034)
#define DRZH2N_T1_DBG_RDATA	 (0xB040)

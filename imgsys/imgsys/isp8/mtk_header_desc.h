...
#define V4L2_META_FMT_MTISP_SDNORM   v4l2_fourcc('M', 'T', 's', 'r')
	/* ISP SMVR SD fmt*/
#define V4L2_PIX_FMT_WARP1P      v4l2_fourcc('M', 'W', '1', 'P')
	/* Mediatek warp map 32-bit, 1 plane */
#define V4L2_PIX_FMT_WARP2P      v4l2_fourcc('M', 'W', '2', 'P')
	/* Mediatek warp map 32-bit, 2 plane */
#define V4L2_PIX_FMT_Y12BPACK    v4l2_fourcc('Y', '1', '2', 'P')
	/* Y-12bit packed */
...
#define V4L2_PIX_FMT_MTISP_RGB48 v4l2_fourcc('M', 'R', '1', '6')
	/* RGB-48bit */
#define V4L2_PIX_FMT_MTISP_Y64   v4l2_fourcc('M', 'T', '6', '4')
	/* Y-32bit */

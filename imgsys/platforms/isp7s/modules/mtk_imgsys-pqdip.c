...
#ifdef PQDIP_7S_1
	{0x1220, 0x10000238},		/* PIMGI_P1A_ORIRDMA_CON0 */
	{0x1224, 0x10BE0077},		/* PIMGI_P1A_ORIRDMA_CON1 */
	{0x1228, 0x00000000},		/* PIMGI_P1A_ORIRDMA_CON2 */
	{0x1290, 0x10000120},		/* PIMGBI_P1A_ORIRDMA_CON0 */
	{0x1294, 0x1060003C},		/* PIMGBI_P1A_ORIRDMA_CON1 */
	{0x1298, 0x00000000},		/* PIMGBI_P1A_ORIRDMA_CON2 */
	{0x1300, 0x10000090},		/* PIMGCI_P1A_ORIRDMA_CON0 */
	{0x1304, 0x1030001E},		/* PIMGCI_P1A_ORIRDMA_CON1 */
	{0x1308, 0x00000000},		/* PIMGCI_P1A_ORIRDMA_CON2 */
	{0x1370, 0x10000040},		/* TCCSI_P1A_ORIRDMA_CON0 */
	{0x1374, 0x1016000E},		/* TCCSI_P1A_ORIRDMA_CON1 */
	{0x1378, 0x00000000},		/* TCCSI_P1A_ORIRDMA_CON2 */
	{0x13E0, 0x10000040},		/* TCCSO_P1A_ORIWDMA_CON0 */
	{0x13E4, 0x1016000E},		/* TCCSO_P1A_ORIWDMA_CON1 */
	{0x13E8, 0x00000000},		/* TCCSO_P1A_ORIWDMA_CON2 */
#else
	{0x1220, 0x10000090},		/* PIMGI_P1A_ORIRDMA_CON0 */
	{0x1224, 0x1030001E},		/* PIMGI_P1A_ORIRDMA_CON1 */
	{0x1228, 0x00000000},		/* PIMGI_P1A_ORIRDMA_CON2 */
	{0x1290, 0x10000090},		/* PIMGBI_P1A_ORIRDMA_CON0 */
	{0x1294, 0x1030001E},		/* PIMGBI_P1A_ORIRDMA_CON1 */
	{0x1298, 0x00000000},		/* PIMGBI_P1A_ORIRDMA_CON2 */
	{0x1300, 0x10000090},		/* PIMGCI_P1A_ORIRDMA_CON0 */
	{0x1304, 0x1030001E},		/* PIMGCI_P1A_ORIRDMA_CON1 */
	{0x1308, 0x00000000},		/* PIMGCI_P1A_ORIRDMA_CON2 */

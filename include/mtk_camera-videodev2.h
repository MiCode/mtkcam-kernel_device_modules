...
#define V4L2_PIX_FMT_MTISP_SBGGR24  v4l2_fourcc('M', 'B', 'B', 'o')
#define V4L2_PIX_FMT_MTISP_SGBRG24  v4l2_fourcc('M', 'B', 'G', 'o')
#define V4L2_PIX_FMT_MTISP_SGRBG24  v4l2_fourcc('M', 'B', 'g', 'o')
#define V4L2_PIX_FMT_MTISP_SRGGB24  v4l2_fourcc('M', 'B', 'R', 'o')

...
void mtk_aie_register_tf_cb_7sp_1(void *data)
{
#ifdef AIE_TF_DUMP_7SP_1
...
EXPORT_SYMBOL(mtk_aie_register_tf_cb_7sp_1);

int mtk_aie_debug_7sp_1_probe(struct platform_device *pdev)
{
    dev_info(&pdev->dev ,"%s+", __func__);
    register_mtk_aie_reg_tf_cb(mtk_aie_register_tf_cb_7sp_1);
    dev_info(&pdev->dev ,"%s-", __func__);

    return 0;
}

int mtk_aie_debug_7sp_1_remove(struct platform_device *pdev)
{
...
static const struct of_device_id of_match_mtk_aie_debug_7sp_1_drv[] = {
	{
...
static struct platform_driver mtk_aie_debug_7sp_1_drv = {
	.probe = mtk_aie_debug_7sp_1_probe,
    .remove = mtk_aie_debug_7sp_1_remove,
	.driver = {
		.name = "mtk-aie-debug-7sp-1",
        .of_match_table = of_match_mtk_aie_debug_7sp_1_drv,
	},
};

module_platform_driver(mtk_aie_debug_7sp_1_drv);

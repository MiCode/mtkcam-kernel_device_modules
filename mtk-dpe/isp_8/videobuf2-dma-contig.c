...
const struct vb2_mem_ops vb2_dpe_dma_contig_memops_isp8 = {
	.alloc		= vb2_dc_alloc,
	.put		= vb2_dc_put,
...
EXPORT_SYMBOL_GPL(vb2_dpe_dma_contig_memops_isp8);
 ...
 */
void vb2_dpe_dma_contig_clear_max_seg_size_isp8(struct device *dev)
{
	kfree(dev->dma_parms);
	dev->dma_parms = NULL;
}
EXPORT_SYMBOL_GPL(vb2_dpe_dma_contig_clear_max_seg_size_isp8);

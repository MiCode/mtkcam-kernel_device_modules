...
static struct mtk_hcp_smvr_reserve_mblock isp8_smvr_mblock[] = {
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x5CA300, /*align_4096(0xB987E0) */
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x84AF00, /*align_4096(0x18D81E0) */
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x865300, /*align_4096(0xEE7320) */
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x179D000, /*align_4096(0x1D22000) */
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x209E00, /*align_4096(0x125100) */
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0xC0800, /*align_4096(0x1E0400) */
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x171DA00,//to do for smvr //0xF68400, //0x2000000,
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
...
static struct mtk_hcp_streaming_reserve_mblock isp8_streaming_mblock[] = {
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0xFED000, // explicit: 0x77EC00,
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
...
static struct mtk_hcp_capture_reserve_mblock isp8_capture_mblock[] = {
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0xEEAA00, //0xDFB600, //0xDC5800,
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,

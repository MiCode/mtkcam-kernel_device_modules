...
static struct mtk_hcp_smvr_reserve_mblock isp8_smvr_mblock[] = {
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x72B000, /*align_4096(0x72A760) */
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x776000, /*align_4096(0x776000) */
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0xAC9000, /*align_4096(0xAC8DF8) */
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x24B000, /*align_4096(0x24A800) */
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x1208800,//to do for smvr //0xF68400, //0x2000000,
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
...
static struct mtk_hcp_streaming_reserve_mblock isp8_streaming_mblock[] = {
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x8B000,   /*align_4096(0x8A400) */
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x32000,   /*align_4096(0x31C00) */
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x584000,   /*align_4096(0x583760) */
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x3BB000,   /*align_4096(0x3BB000) */
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x78D000,   /*align_4096(0x78CDF8) */
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x126000,   /*align_4096(0x125400) */
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x121000,   /*align_4096(0x120800) */
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x759300, // explicit: 0x77EC00,
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
...
static struct mtk_hcp_capture_reserve_mblock isp8_capture_mblock[] = {
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x809000, /*align_4096(0x808760) */
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x1A2000, /*align_4096(0x1A1D00) */
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x92B000, /*align_4096(0x92ADF8) */
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x31000,   /*align_4096(0x30e00) */
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x559000, //0xDFB600, //0xDC5800,
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,

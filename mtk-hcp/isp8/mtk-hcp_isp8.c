...
static struct mtk_hcp_streaming_reserve_mblock isp8_streaming_mblock[] = {
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x39EA00,   /*0x596000 5MB + 600KB*/
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x52CC00,   /*0x67D000 6MB + 500KB*/
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0xE2C000,   /*0x207D000 32MB + 500KB*/
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0xE5000,   /*0x1C8000 1MB + 800KB*/
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0xEFDC00,//to do for smvr //0xF68400, //0x2000000,
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
...
static struct mtk_hcp_capture_reserve_mblock isp8_capture_mblock[] = {
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x360E00, //0x194000,   /*5MB + 600KB*/
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x59B200, //0x1C6000,   /*6MB + 500KB*/
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x1377000, //0x1783000,   /*32MB + 500KB*/
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
...
int isp8_allocate_working_buffer(struct mtk_hcp *hcp_dev, unsigned int mode, unsigned int gmb_en)
{
        ...
        if (mode == imgsys_streaming) {
            ...
            isp8_module_driver_allocate_working_buffer_streaming(hcp_dev, mode, mblock);
        } else if (mode == imgsys_capture) {
            pr_info("mtk_hcp: allocate capture buffer\n");
            isp8_module_driver_allocate_working_buffer_capture(hcp_dev, mode, cmblock);
        } else {
            pr_info("mtk_hcp: allocate smvr buffer\n");
            isp8_module_driver_allocate_working_buffer_smvr(hcp_dev, mode, smblock);
        }

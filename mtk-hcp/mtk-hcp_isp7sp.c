...
static struct mtk_hcp_smvr_reserve_mblock isp7sp_smvr_mblock[] = {
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x19B000, //align_4096(0x25D700)
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x233000, /*align_4096(0x8AC000) */
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x71F000, /*align_4096(0xB987E0) */
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x16F4000, /*align_4096(0x18D81E0) */
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0xA91000, /*align_4096(0xEE7320) */
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x17D5000, /*align_4096(0x1D22000) */
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x16E000, /*align_4096(0x125100) */
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x11E000, /*align_4096(0x1E0400) */
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
...
static struct mtk_hcp_streaming_reserve_mblock isp7sp_streaming_mblock[] = {
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x564000,   /*0x67D000 6MB + 500KB*/
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x1463000,   /*0x207D000 32MB + 500KB*/
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0xAC000,   /*0x1C8000 1MB + 800KB*/
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
...
static struct mtk_hcp_capture_reserve_mblock isp7sp_capture_mblock[] = {
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x380000, //0x194000,   /*5MB + 600KB*/
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x564000, //0x1C6000,   /*6MB + 500KB*/
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x1463000, //0x1783000,   /*32MB + 500KB*/
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,

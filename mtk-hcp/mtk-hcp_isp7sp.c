...
static struct mtk_hcp_smvr_reserve_mblock isp7sp_smvr_mblock[] = {
	{
		.name = "WPE_MEM_C_ID",
		.num = WPE_MEM_C_ID,
		.start_phys = 0x0,
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x190000, //align_4096(0x25D700)
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x21C600, /*align_4096(0x8AC000) */
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x56E000, /*align_4096(0xB987E0) */
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x774000, /*align_4096(0x18D81E0) */
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x7C4000, /*align_4096(0xEE7320) */
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0xA88000, /*align_4096(0x1D22000) */
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x124B00, /*align_4096(0x125100) */
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0xE4800, /*align_4096(0x1E0400) */
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x14EC800,//to do for smvr //0xF68400, //0x2000000,
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
...
static struct mtk_hcp_streaming_reserve_mblock isp7sp_streaming_mblock[] = {
	{
		.name = "WPE_MEM_C_ID",
		.num = WPE_MEM_C_ID,
		.start_phys = 0x0,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x1CF500,   /*0x596000 5MB + 600KB*/
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x296600,   /*0x67D000 6MB + 500KB*/
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x716000,   /*0x207D000 32MB + 500KB*/
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x72800,   /*0x1C8000 1MB + 800KB*/
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x77EE00,//to do for smvr //0xF68400, //0x2000000,
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
...
static struct mtk_hcp_capture_reserve_mblock isp7sp_capture_mblock[] = {
	{
		.name = "WPE_MEM_C_ID",
		.num = WPE_MEM_C_ID,
		.start_phys = 0x0,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x1B0700, //0x194000,   /*5MB + 600KB*/
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0x2CD900, //0x1C6000,   /*6MB + 500KB*/
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0xD4D800, //0x1783000,   /*32MB + 500KB*/
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
	...
	},
	{
		...
		.start_virt = 0x0,
		.start_dma  = 0x0,
		.size = 0xDC5800,//to do for smvr //0xF68400, //0x2000000,
		.is_dma_buf = true,
		.mmap_cnt = 0,
		.mem_priv = NULL,
		.d_buf = NULL,
...
static struct mtk_hcp_gce_token_reserve_mblock isp7sp_gce_mblock[] = {
	{
		/*share buffer for frame setting, to be sw usage*/
		.name = "IMG_MEM_FOR_HW_ID",
		.num = IMG_MEM_FOR_HW_ID,
...
#endif
#if SMVR_DECOUPLE
phys_addr_t isp7sp_get_reserve_mem_phys(unsigned int id, unsigned int mode)
{
...
void *isp7sp_get_reserve_mem_virt(unsigned int id, unsigned int mode)
{
	if (id >= (NUMS_CM_MEM_ID)) {
...
phys_addr_t isp7sp_get_reserve_mem_dma(unsigned int id, unsigned int mode)
{
	if (id >= (NUMS_CM_MEM_ID)) {
		pr_info("[HCP] no reserve memory for %u", id);
		return 0;
...
phys_addr_t isp7sp_get_reserve_mem_size(unsigned int id, unsigned int mode)
{
	if (id >= (NUMS_CM_MEM_ID)) {
		pr_info("[HCP] no reserve memory for %u", id);
		return 0;
...
uint32_t isp7sp_get_reserve_mem_fd(unsigned int id, unsigned int mode)
{
	if (id >= (NUMS_CM_MEM_ID)) {
		pr_info("[HCP] no reserve memory for %u", id);
		return 0;
...
EXPORT_SYMBOL(isp7sp_get_gce_token_virt);

void *isp7sp_get_wpe_virt(unsigned int mode)
{
	if (mode == imgsys_streaming)
...
int isp7sp_get_wpe_cq_fd(unsigned int mode)
{
	if (mode == imgsys_streaming)
...
int isp7sp_get_wpe_tdr_fd(unsigned int mode)
{
	if (mode == imgsys_streaming)
...
void *isp7sp_get_dip_virt(unsigned int mode)
{
	if (mode == imgsys_streaming)
...
int isp7sp_get_dip_cq_fd(unsigned int mode)
{
	if (mode == imgsys_streaming)
...
int isp7sp_get_dip_tdr_fd(unsigned int mode)
{
	if (mode == imgsys_streaming)
...
void *isp7sp_get_traw_virt(unsigned int mode)
{
	if (mode == imgsys_streaming)
...
int isp7sp_get_traw_cq_fd(unsigned int mode)
{
	if (mode == imgsys_streaming)
...
int isp7sp_get_traw_tdr_fd(unsigned int mode)
{
	if (mode == imgsys_streaming)
...
void *isp7sp_get_pqdip_virt(unsigned int mode)
{
	if (mode == imgsys_streaming)
...
int isp7sp_get_pqdip_cq_fd(unsigned int mode)
{
	if (mode == imgsys_streaming)
...
int isp7sp_get_pqdip_tdr_fd(unsigned int mode)
{
	if (mode == imgsys_streaming)
...
static int isp7sp_module_driver_allocate_working_buffer_streaming(struct mtk_hcp *hcp_dev,
        ...
        for (id = 0; id < block_num; id++) {
            if (str_mblock[id].is_dma_buf) {
                ...
                case IMG_MEM_G_ID:
                        ...
                        if (hcp_dbg_enable()) {
                            pr_info("%s:[HCP_GCE][%s] phys:0x%llx, virt:0x%p, dma:0x%llx,"
                                ...
                                isp7sp_get_reserve_mem_phys(id, str_mode),
                                isp7sp_get_reserve_mem_virt(id, str_mode),
                                isp7sp_get_reserve_mem_dma(id, str_mode),
                                isp7sp_get_reserve_mem_size(id, str_mode),
                                str_mblock[id].is_dma_buf,
                                isp7sp_get_reserve_mem_fd(id, str_mode),
                                str_mblock[id].d_buf);
                        }
                        break;
                case WPE_MEM_C_ID:
                ...
                case ADL_MEM_T_ID:
                    ...
                    dma_buf_fd(str_mblock[id].d_buf, O_RDWR | O_CLOEXEC);
                    if (hcp_dbg_enable()) {
                        pr_info("%s:[HCP_WORKING][%s] phys:0x%llx, virt:0x%p,"
                ...
                default:
                    ...
                    dma_buf_fd(str_mblock[id].d_buf, O_RDWR | O_CLOEXEC);
                    if (hcp_dbg_enable()) {
                        pr_info("%s:[HCP_WORKING_DEFAULT][%s] phys:0x%llx,"
...
static int isp7sp_module_driver_allocate_working_buffer_capture(struct mtk_hcp *hcp_dev,
        ...
        for (id = 0; id < block_num; id++) {
            if (cap_mblock[id].is_dma_buf) {
                ...
                case IMG_MEM_G_ID:
                        ...
                        if (hcp_dbg_enable()) {
                            pr_info("%s:[HCP_GCE][%s] phys:0x%llx, virt:0x%p,"
                                " dma:0x%llx, size:0x%llx, is_dma_buf:%d, fd:%d, d_buf:0x%p\n",
...
static int isp7sp_module_driver_allocate_working_buffer_smvr(struct mtk_hcp *hcp_dev,
        ...
        for (g_id = 0; g_id < block_num_gce; g_id++) {
                if (gmblock[g_id].is_dma_buf) {
                    ...
                    /* (ls /dev/dma_heap/) in shell */
                        ...
                        if (hcp_dbg_enable()) {
                            pr_info("%s:[HCP_GCE_TOKEN][%s] phys:0x%llx, virt:0x%p, dma:0x%llx,"
                                " size:0x%llx, is_dma_buf:%d, fd:%d, d_buf:0x%p\n",
...
static void gce_release_streaming(struct kref *ref)
{
    ...
    if (hcp_dbg_enable()) {
	    pr_info("%s:[HCP][%s] phys:0x%llx, virt:0x%p, dma:0x%llx, size:0x%llx,"
            " is_dma_buf:%d, fd:%d, d_buf:0x%p\n",
    		__func__, mblock->name,
    		#if SMVR_DECOUPLE
    		isp7sp_get_reserve_mem_phys(IMG_MEM_G_ID, imgsys_streaming),
    		isp7sp_get_reserve_mem_virt(IMG_MEM_G_ID, imgsys_streaming),
    		isp7sp_get_reserve_mem_dma(IMG_MEM_G_ID, imgsys_streaming),
    		isp7sp_get_reserve_mem_size(IMG_MEM_G_ID, imgsys_streaming),
    		mblock->is_dma_buf,
    		isp7sp_get_reserve_mem_fd(IMG_MEM_G_ID, imgsys_streaming),
    		#else
...
static void gce_release_capture(struct kref *ref)
{
    ...
    if (hcp_dbg_enable()) {
	    pr_info("%s:[HCP][%s] phys:0x%llx, virt:0x%p, dma:0x%llx, size:0x%llx,"
    		...
    		__func__, mblock->name,
    		#if SMVR_DECOUPLE
    		isp7sp_get_reserve_mem_phys(IMG_MEM_G_ID, imgsys_capture),
    		isp7sp_get_reserve_mem_virt(IMG_MEM_G_ID, imgsys_capture),
    		isp7sp_get_reserve_mem_dma(IMG_MEM_G_ID, imgsys_capture),
    		isp7sp_get_reserve_mem_size(IMG_MEM_G_ID, imgsys_capture),
    		mblock->is_dma_buf,
    		isp7sp_get_reserve_mem_fd(IMG_MEM_G_ID, imgsys_capture),
    		#else
    		isp7sp_get_reserve_mem_phys(IMG_MEM_G_ID),
    		isp7sp_get_reserve_mem_virt(IMG_MEM_G_ID),
    		isp7sp_get_reserve_mem_dma(IMG_MEM_G_ID),
	...
	for (id = 0; id < block_num; id++) {
		if (mblock[id].is_dma_buf) {
			...
			case IMG_MEM_G_ID:
                ...
                if (hcp_dbg_enable()) {
				    pr_info("%s:[HCP][%s] phys:0x%llx, virt:0x%p, dma:0x%llx,"
                        " size:0x%llx, is_dma_buf:%d, fd:%d, d_buf:0x%p\n",
...
#endif
#if SMVR_DECOUPLE
static int isp7sp_module_driver_release_working_buffer_streaming(struct mtk_hcp *hcp_dev,
    unsigned int str_mode, struct mtk_hcp_streaming_reserve_mblock *str_mblock)
{
...
int isp7sp_release_working_buffer(struct mtk_hcp *hcp_dev, unsigned int mode)
{
        ...
        if (mode == imgsys_streaming) {
            isp7sp_module_driver_release_working_buffer_streaming(hcp_dev, mode, mblock);
        } else if (mode == imgsys_capture) {
            isp7sp_module_driver_release_working_buffer_capture(hcp_dev, mode, cmblock);
        } else {
            isp7sp_module_driver_release_working_buffer_smvr(hcp_dev, mode, smblock);
        }
    ...
    if (!info->is_capture) {
        ...
        /*WPE:0, ADL:1, TRAW:2, DIP:3, PQDIP:4 */
       	info->module_info_streaming[0].c_wbuf =
       				isp7sp_get_reserve_mem_phys(WPE_MEM_C_ID, imgsys_streaming);
       	info->module_info_streaming[0].c_wbuf_dma =
       				isp7sp_get_reserve_mem_dma(WPE_MEM_C_ID, imgsys_streaming);
       	info->module_info_streaming[0].c_wbuf_sz =
       				isp7sp_get_reserve_mem_size(WPE_MEM_C_ID, imgsys_streaming);
       	info->module_info_streaming[0].c_wbuf_fd =
       				isp7sp_get_reserve_mem_fd(WPE_MEM_C_ID, imgsys_streaming);
       	info->module_info_streaming[0].t_wbuf =
       				isp7sp_get_reserve_mem_phys(WPE_MEM_T_ID, imgsys_streaming);
       	info->module_info_streaming[0].t_wbuf_dma =
       				isp7sp_get_reserve_mem_dma(WPE_MEM_T_ID, imgsys_streaming);
       	info->module_info_streaming[0].t_wbuf_sz =
       				isp7sp_get_reserve_mem_size(WPE_MEM_T_ID, imgsys_streaming);
       	info->module_info_streaming[0].t_wbuf_fd =
       				isp7sp_get_reserve_mem_fd(WPE_MEM_T_ID, imgsys_streaming);

         // ADL
       	info->module_info_streaming[1].c_wbuf =
       				isp7sp_get_reserve_mem_phys(ADL_MEM_C_ID, imgsys_streaming);
       	info->module_info_streaming[1].c_wbuf_dma =
       				isp7sp_get_reserve_mem_dma(ADL_MEM_C_ID, imgsys_streaming);
       	info->module_info_streaming[1].c_wbuf_sz =
       				isp7sp_get_reserve_mem_size(ADL_MEM_C_ID, imgsys_streaming);
       	info->module_info_streaming[1].c_wbuf_fd =
       				isp7sp_get_reserve_mem_fd(ADL_MEM_C_ID, imgsys_streaming);
       	info->module_info_streaming[1].t_wbuf =
       				isp7sp_get_reserve_mem_phys(ADL_MEM_T_ID, imgsys_streaming);
       	info->module_info_streaming[1].t_wbuf_dma =
       				isp7sp_get_reserve_mem_dma(ADL_MEM_T_ID, imgsys_streaming);
       	info->module_info_streaming[1].t_wbuf_sz =
       				isp7sp_get_reserve_mem_size(ADL_MEM_T_ID, imgsys_streaming);
       	info->module_info_streaming[1].t_wbuf_fd =
       				isp7sp_get_reserve_mem_fd(ADL_MEM_T_ID, imgsys_streaming);

       	// TRAW
       	info->module_info_streaming[2].c_wbuf =
       				isp7sp_get_reserve_mem_phys(TRAW_MEM_C_ID, imgsys_streaming);
       	info->module_info_streaming[2].c_wbuf_dma =
       				isp7sp_get_reserve_mem_dma(TRAW_MEM_C_ID, imgsys_streaming);
       	info->module_info_streaming[2].c_wbuf_sz =
       				isp7sp_get_reserve_mem_size(TRAW_MEM_C_ID, imgsys_streaming);
       	info->module_info_streaming[2].c_wbuf_fd =
       				isp7sp_get_reserve_mem_fd(TRAW_MEM_C_ID, imgsys_streaming);
       	info->module_info_streaming[2].t_wbuf =
       				isp7sp_get_reserve_mem_phys(TRAW_MEM_T_ID, imgsys_streaming);
       	info->module_info_streaming[2].t_wbuf_dma =
       				isp7sp_get_reserve_mem_dma(TRAW_MEM_T_ID, imgsys_streaming);
       	info->module_info_streaming[2].t_wbuf_sz =
       				isp7sp_get_reserve_mem_size(TRAW_MEM_T_ID, imgsys_streaming);
       	info->module_info_streaming[2].t_wbuf_fd =
       				isp7sp_get_reserve_mem_fd(TRAW_MEM_T_ID, imgsys_streaming);

       		// DIP
       	info->module_info_streaming[3].c_wbuf =
       				isp7sp_get_reserve_mem_phys(DIP_MEM_C_ID, imgsys_streaming);
       	info->module_info_streaming[3].c_wbuf_dma =
       				isp7sp_get_reserve_mem_dma(DIP_MEM_C_ID, imgsys_streaming);
       	info->module_info_streaming[3].c_wbuf_sz =
       				isp7sp_get_reserve_mem_size(DIP_MEM_C_ID, imgsys_streaming);
       	info->module_info_streaming[3].c_wbuf_fd =
       				isp7sp_get_reserve_mem_fd(DIP_MEM_C_ID, imgsys_streaming);
       	info->module_info_streaming[3].t_wbuf =
       				isp7sp_get_reserve_mem_phys(DIP_MEM_T_ID, imgsys_streaming);
       	info->module_info_streaming[3].t_wbuf_dma =
       				isp7sp_get_reserve_mem_dma(DIP_MEM_T_ID, imgsys_streaming);
       	info->module_info_streaming[3].t_wbuf_sz =
       				isp7sp_get_reserve_mem_size(DIP_MEM_T_ID, imgsys_streaming);
       	info->module_info_streaming[3].t_wbuf_fd =
       				isp7sp_get_reserve_mem_fd(DIP_MEM_T_ID, imgsys_streaming);

       	// PQDIP
       	info->module_info_streaming[4].c_wbuf =
       				isp7sp_get_reserve_mem_phys(PQDIP_MEM_C_ID, imgsys_streaming);
       	info->module_info_streaming[4].c_wbuf_dma =
       				isp7sp_get_reserve_mem_dma(PQDIP_MEM_C_ID, imgsys_streaming);
       	info->module_info_streaming[4].c_wbuf_sz =
       				isp7sp_get_reserve_mem_size(PQDIP_MEM_C_ID, imgsys_streaming);
       	info->module_info_streaming[4].c_wbuf_fd =
       			    isp7sp_get_reserve_mem_fd(PQDIP_MEM_C_ID, imgsys_streaming);
       	info->module_info_streaming[4].t_wbuf =
       				isp7sp_get_reserve_mem_phys(PQDIP_MEM_T_ID, imgsys_streaming);
       	info->module_info_streaming[4].t_wbuf_dma =
       				isp7sp_get_reserve_mem_dma(PQDIP_MEM_T_ID, imgsys_streaming);
       	info->module_info_streaming[4].t_wbuf_sz =
       				isp7sp_get_reserve_mem_size(PQDIP_MEM_T_ID, imgsys_streaming);
       	info->module_info_streaming[4].t_wbuf_fd =
       				isp7sp_get_reserve_mem_fd(PQDIP_MEM_T_ID, imgsys_streaming);

        if (hcp_dbg_enable()) {
	        pr_info("mtk_hcp:streaming(fd/buf/sz(%d/%lx/%lx))",
	        isp7sp_get_reserve_mem_fd(IMG_MEM_G_ID, imgsys_streaming),
	        (unsigned long)isp7sp_get_reserve_mem_phys(IMG_MEM_G_ID, imgsys_streaming),
	        (unsigned long)isp7sp_get_reserve_mem_size(IMG_MEM_G_ID, imgsys_streaming));
        }
        info->gce_info[imgsys_streaming].g_wbuf_fd = isp7sp_get_reserve_mem_fd(IMG_MEM_G_ID, imgsys_streaming);
        info->gce_info[imgsys_streaming].g_wbuf = isp7sp_get_reserve_mem_phys(IMG_MEM_G_ID, imgsys_streaming);
        info->gce_info[imgsys_streaming].g_wbuf_sz = isp7sp_get_reserve_mem_size(IMG_MEM_G_ID, imgsys_streaming);
        } else {
	/*WPE:0, ADL:1, TRAW:2, DIP:3, PQDIP:4 */
       	info->module_info_smvr[0].c_wbuf =
       				isp7sp_get_reserve_mem_phys(WPE_MEM_C_ID, imgsys_smvr);
       	info->module_info_smvr[0].c_wbuf_dma =
       				isp7sp_get_reserve_mem_dma(WPE_MEM_C_ID, imgsys_smvr);
       	info->module_info_smvr[0].c_wbuf_sz =
       				isp7sp_get_reserve_mem_size(WPE_MEM_C_ID, imgsys_smvr);
       	info->module_info_smvr[0].c_wbuf_fd =
       				isp7sp_get_reserve_mem_fd(WPE_MEM_C_ID, imgsys_smvr);
       	info->module_info_smvr[0].t_wbuf =
       				isp7sp_get_reserve_mem_phys(WPE_MEM_T_ID, imgsys_smvr);
       	info->module_info_smvr[0].t_wbuf_dma =
       				isp7sp_get_reserve_mem_dma(WPE_MEM_T_ID, imgsys_smvr);
       	info->module_info_smvr[0].t_wbuf_sz =
       				isp7sp_get_reserve_mem_size(WPE_MEM_T_ID, imgsys_smvr);
       	info->module_info_smvr[0].t_wbuf_fd =
       				isp7sp_get_reserve_mem_fd(WPE_MEM_T_ID, imgsys_smvr);

         // ADL
       	info->module_info_smvr[1].c_wbuf =
       				isp7sp_get_reserve_mem_phys(ADL_MEM_C_ID, imgsys_smvr);
       	info->module_info_smvr[1].c_wbuf_dma =
       				isp7sp_get_reserve_mem_dma(ADL_MEM_C_ID, imgsys_smvr);
       	info->module_info_smvr[1].c_wbuf_sz =
       				isp7sp_get_reserve_mem_size(ADL_MEM_C_ID, imgsys_smvr);
       	info->module_info_smvr[1].c_wbuf_fd =
       				isp7sp_get_reserve_mem_fd(ADL_MEM_C_ID, imgsys_smvr);
       	info->module_info_smvr[1].t_wbuf =
       				isp7sp_get_reserve_mem_phys(ADL_MEM_T_ID, imgsys_smvr);
       	info->module_info_smvr[1].t_wbuf_dma =
       				isp7sp_get_reserve_mem_dma(ADL_MEM_T_ID, imgsys_smvr);
       	info->module_info_smvr[1].t_wbuf_sz =
       				isp7sp_get_reserve_mem_size(ADL_MEM_T_ID, imgsys_smvr);
       	info->module_info_smvr[1].t_wbuf_fd =
       				isp7sp_get_reserve_mem_fd(ADL_MEM_T_ID, imgsys_smvr);

       	// TRAW
       	info->module_info_smvr[2].c_wbuf =
       				isp7sp_get_reserve_mem_phys(TRAW_MEM_C_ID, imgsys_smvr);
       	info->module_info_smvr[2].c_wbuf_dma =
       				isp7sp_get_reserve_mem_dma(TRAW_MEM_C_ID, imgsys_smvr);
       	info->module_info_smvr[2].c_wbuf_sz =
       				isp7sp_get_reserve_mem_size(TRAW_MEM_C_ID, imgsys_smvr);
       	info->module_info_smvr[2].c_wbuf_fd =
       				isp7sp_get_reserve_mem_fd(TRAW_MEM_C_ID, imgsys_smvr);
       	info->module_info_smvr[2].t_wbuf =
       				isp7sp_get_reserve_mem_phys(TRAW_MEM_T_ID, imgsys_smvr);
       	info->module_info_smvr[2].t_wbuf_dma =
       				isp7sp_get_reserve_mem_dma(TRAW_MEM_T_ID, imgsys_smvr);
       	info->module_info_smvr[2].t_wbuf_sz =
       				isp7sp_get_reserve_mem_size(TRAW_MEM_T_ID, imgsys_smvr);
       	info->module_info_smvr[2].t_wbuf_fd =
       				isp7sp_get_reserve_mem_fd(TRAW_MEM_T_ID, imgsys_smvr);

       		// DIP
       	info->module_info_smvr[3].c_wbuf =
       				isp7sp_get_reserve_mem_phys(DIP_MEM_C_ID, imgsys_smvr);
       	info->module_info_smvr[3].c_wbuf_dma =
       				isp7sp_get_reserve_mem_dma(DIP_MEM_C_ID, imgsys_smvr);
       	info->module_info_smvr[3].c_wbuf_sz =
       				isp7sp_get_reserve_mem_size(DIP_MEM_C_ID, imgsys_smvr);
       	info->module_info_smvr[3].c_wbuf_fd =
       				isp7sp_get_reserve_mem_fd(DIP_MEM_C_ID, imgsys_smvr);
       	info->module_info_smvr[3].t_wbuf =
       				isp7sp_get_reserve_mem_phys(DIP_MEM_T_ID, imgsys_smvr);
       	info->module_info_smvr[3].t_wbuf_dma =
       				isp7sp_get_reserve_mem_dma(DIP_MEM_T_ID, imgsys_smvr);
       	info->module_info_smvr[3].t_wbuf_sz =
       				isp7sp_get_reserve_mem_size(DIP_MEM_T_ID, imgsys_smvr);
       	info->module_info_smvr[3].t_wbuf_fd =
       				isp7sp_get_reserve_mem_fd(DIP_MEM_T_ID, imgsys_smvr);

       	// PQDIP
       	info->module_info_smvr[4].c_wbuf =
       				isp7sp_get_reserve_mem_phys(PQDIP_MEM_C_ID, imgsys_smvr);
       	info->module_info_smvr[4].c_wbuf_dma =
       				isp7sp_get_reserve_mem_dma(PQDIP_MEM_C_ID, imgsys_smvr);
       	info->module_info_smvr[4].c_wbuf_sz =
       				isp7sp_get_reserve_mem_size(PQDIP_MEM_C_ID, imgsys_smvr);
       	info->module_info_smvr[4].c_wbuf_fd =
       			    isp7sp_get_reserve_mem_fd(PQDIP_MEM_C_ID, imgsys_smvr);
       	info->module_info_smvr[4].t_wbuf =
       				isp7sp_get_reserve_mem_phys(PQDIP_MEM_T_ID, imgsys_smvr);
       	info->module_info_smvr[4].t_wbuf_dma =
       				isp7sp_get_reserve_mem_dma(PQDIP_MEM_T_ID, imgsys_smvr);
       	info->module_info_smvr[4].t_wbuf_sz =
       				isp7sp_get_reserve_mem_size(PQDIP_MEM_T_ID, imgsys_smvr);
       	info->module_info_smvr[4].t_wbuf_fd =
       				isp7sp_get_reserve_mem_fd(PQDIP_MEM_T_ID, imgsys_smvr);

        if (hcp_dbg_enable()) {
            pr_info("mtk_hcp:smvr(fd/buf/sz(%d/%lx/%lx))",
    	    isp7sp_get_reserve_mem_fd(IMG_MEM_G_ID, imgsys_smvr),
    	    (unsigned long)isp7sp_get_reserve_mem_phys(IMG_MEM_G_ID, imgsys_smvr),
    	    (unsigned long)isp7sp_get_reserve_mem_size(IMG_MEM_G_ID, imgsys_smvr));
        }
        info->gce_info[imgsys_smvr].g_wbuf_fd = isp7sp_get_reserve_mem_fd(IMG_MEM_G_ID, imgsys_smvr);
        info->gce_info[imgsys_smvr].g_wbuf = isp7sp_get_reserve_mem_phys(IMG_MEM_G_ID, imgsys_smvr);
        info->gce_info[imgsys_smvr].g_wbuf_sz = isp7sp_get_reserve_mem_size(IMG_MEM_G_ID, imgsys_smvr);
        }

    } else {
	/*WPE:0, ADL:1, TRAW:2, DIP:3, PQDIP:4 */
       	info->module_info_capture[0].c_wbuf =
				isp7sp_get_reserve_mem_phys(WPE_MEM_C_ID, imgsys_capture);
       	info->module_info_capture[0].c_wbuf_dma =
				isp7sp_get_reserve_mem_dma(WPE_MEM_C_ID, imgsys_capture);
       	info->module_info_capture[0].c_wbuf_sz =
				isp7sp_get_reserve_mem_size(WPE_MEM_C_ID, imgsys_capture);
       	info->module_info_capture[0].c_wbuf_fd =
				isp7sp_get_reserve_mem_fd(WPE_MEM_C_ID, imgsys_capture);
       	info->module_info_capture[0].t_wbuf =
				isp7sp_get_reserve_mem_phys(WPE_MEM_T_ID, imgsys_capture);
       	info->module_info_capture[0].t_wbuf_dma =
				isp7sp_get_reserve_mem_dma(WPE_MEM_T_ID, imgsys_capture);
       	info->module_info_capture[0].t_wbuf_sz =
				isp7sp_get_reserve_mem_size(WPE_MEM_T_ID, imgsys_capture);
       	info->module_info_capture[0].t_wbuf_fd =
				isp7sp_get_reserve_mem_fd(WPE_MEM_T_ID, imgsys_capture);

  // ADL
       	info->module_info_capture[1].c_wbuf =
				isp7sp_get_reserve_mem_phys(ADL_MEM_C_ID, imgsys_capture);
       	info->module_info_capture[1].c_wbuf_dma =
				isp7sp_get_reserve_mem_dma(ADL_MEM_C_ID, imgsys_capture);
       	info->module_info_capture[1].c_wbuf_sz =
				isp7sp_get_reserve_mem_size(ADL_MEM_C_ID, imgsys_capture);
       	info->module_info_capture[1].c_wbuf_fd =
				isp7sp_get_reserve_mem_fd(ADL_MEM_C_ID, imgsys_capture);
       	info->module_info_capture[1].t_wbuf =
				isp7sp_get_reserve_mem_phys(ADL_MEM_T_ID, imgsys_capture);
       	info->module_info_capture[1].t_wbuf_dma =
				isp7sp_get_reserve_mem_dma(ADL_MEM_T_ID, imgsys_capture);
       	info->module_info_capture[1].t_wbuf_sz =
				isp7sp_get_reserve_mem_size(ADL_MEM_T_ID, imgsys_capture);
       	info->module_info_capture[1].t_wbuf_fd =
				isp7sp_get_reserve_mem_fd(ADL_MEM_T_ID, imgsys_capture);

	// TRAW
       	info->module_info_capture[2].c_wbuf =
				isp7sp_get_reserve_mem_phys(TRAW_MEM_C_ID, imgsys_capture);
       	info->module_info_capture[2].c_wbuf_dma =
				isp7sp_get_reserve_mem_dma(TRAW_MEM_C_ID, imgsys_capture);
       	info->module_info_capture[2].c_wbuf_sz =
				isp7sp_get_reserve_mem_size(TRAW_MEM_C_ID, imgsys_capture);
       	info->module_info_capture[2].c_wbuf_fd =
				isp7sp_get_reserve_mem_fd(TRAW_MEM_C_ID, imgsys_capture);
       	info->module_info_capture[2].t_wbuf =
				isp7sp_get_reserve_mem_phys(TRAW_MEM_T_ID, imgsys_capture);
       	info->module_info_capture[2].t_wbuf_dma =
				isp7sp_get_reserve_mem_dma(TRAW_MEM_T_ID, imgsys_capture);
       	info->module_info_capture[2].t_wbuf_sz =
				isp7sp_get_reserve_mem_size(TRAW_MEM_T_ID, imgsys_capture);
       	info->module_info_capture[2].t_wbuf_fd =
				isp7sp_get_reserve_mem_fd(TRAW_MEM_T_ID, imgsys_capture);

		// DIP
       	info->module_info_capture[3].c_wbuf =
				isp7sp_get_reserve_mem_phys(DIP_MEM_C_ID, imgsys_capture);
       	info->module_info_capture[3].c_wbuf_dma =
				isp7sp_get_reserve_mem_dma(DIP_MEM_C_ID, imgsys_capture);
       	info->module_info_capture[3].c_wbuf_sz =
				isp7sp_get_reserve_mem_size(DIP_MEM_C_ID, imgsys_capture);
       	info->module_info_capture[3].c_wbuf_fd =
				isp7sp_get_reserve_mem_fd(DIP_MEM_C_ID, imgsys_capture);
       	info->module_info_capture[3].t_wbuf =
				isp7sp_get_reserve_mem_phys(DIP_MEM_T_ID, imgsys_capture);
       	info->module_info_capture[3].t_wbuf_dma =
				isp7sp_get_reserve_mem_dma(DIP_MEM_T_ID, imgsys_capture);
       	info->module_info_capture[3].t_wbuf_sz =
				isp7sp_get_reserve_mem_size(DIP_MEM_T_ID, imgsys_capture);
       	info->module_info_capture[3].t_wbuf_fd =
				isp7sp_get_reserve_mem_fd(DIP_MEM_T_ID, imgsys_capture);

	// PQDIP
       	info->module_info_capture[4].c_wbuf =
				isp7sp_get_reserve_mem_phys(PQDIP_MEM_C_ID, imgsys_capture);
       	info->module_info_capture[4].c_wbuf_dma =
				isp7sp_get_reserve_mem_dma(PQDIP_MEM_C_ID, imgsys_capture);
       	info->module_info_capture[4].c_wbuf_sz =
				isp7sp_get_reserve_mem_size(PQDIP_MEM_C_ID, imgsys_capture);
       	info->module_info_capture[4].c_wbuf_fd =
			isp7sp_get_reserve_mem_fd(PQDIP_MEM_C_ID, imgsys_capture);
       	info->module_info_capture[4].t_wbuf =
				isp7sp_get_reserve_mem_phys(PQDIP_MEM_T_ID, imgsys_capture);
       	info->module_info_capture[4].t_wbuf_dma =
				isp7sp_get_reserve_mem_dma(PQDIP_MEM_T_ID, imgsys_capture);
       	info->module_info_capture[4].t_wbuf_sz =
				isp7sp_get_reserve_mem_size(PQDIP_MEM_T_ID, imgsys_capture);
       	info->module_info_capture[4].t_wbuf_fd =
				isp7sp_get_reserve_mem_fd(PQDIP_MEM_T_ID, imgsys_capture);

        if (hcp_dbg_enable()) {
    	    pr_info("mtk_hcp:capture(fd/buf/sz(%d/%lx/%lx))",
    	    isp7sp_get_reserve_mem_fd(IMG_MEM_G_ID, imgsys_capture),
    	    (unsigned long)isp7sp_get_reserve_mem_phys(IMG_MEM_G_ID, imgsys_capture),
    	    (unsigned long)isp7sp_get_reserve_mem_size(IMG_MEM_G_ID, imgsys_capture));
        }
        info->gce_info[imgsys_capture].g_wbuf_fd = isp7sp_get_reserve_mem_fd(IMG_MEM_G_ID, imgsys_capture);
        info->gce_info[imgsys_capture].g_wbuf = isp7sp_get_reserve_mem_phys(IMG_MEM_G_ID, imgsys_capture);
        info->gce_info[imgsys_capture].g_wbuf_sz = isp7sp_get_reserve_mem_size(IMG_MEM_G_ID, imgsys_capture);
    }
	info->hw_buf = isp7sp_get_reserve_mem_phys(DIP_MEM_FOR_HW_ID, imgsys_streaming);

	/*common*/
    info->g_token_wbuf_fd = isp7sp_get_reserve_mem_fd(IMG_MEM_G_TOKEN_ID, imgsys_streaming);
	info->g_token_wbuf = isp7sp_get_reserve_mem_phys(IMG_MEM_G_TOKEN_ID, imgsys_streaming);
	/*info->g_wbuf_sw = isp7s_get_reserve_mem_virt(IMG_MEM_G_ID);*/
	info->g_token_wbuf_sz = isp7sp_get_reserve_mem_size(IMG_MEM_G_TOKEN_ID, imgsys_streaming);


	return 0;
}

int isp7sp_get_mem_info(struct img_init_info *info)
{
    return 0;
}
...
struct mtk_hcp_data isp7sp_hcp_data = {
	.mblock = isp7sp_streaming_mblock,
	.smblock = isp7sp_smvr_mblock,
	.cmblock = isp7sp_capture_mblock,
	.gmblock = isp7sp_gce_mblock,
	//.gsmblock = isp7s_gce_smvr_mblock,
	.block_num = ARRAY_SIZE(isp7sp_streaming_mblock),
	.block_num_gce = ARRAY_SIZE(isp7sp_gce_mblock),
	.allocate = isp7sp_allocate_working_buffer,
	.release = isp7sp_release_working_buffer,
	.release_gce_buf = isp7sp_release_gce_working_buffer,
	.get_init_info = isp7sp_get_init_info,
	.get_mem_info = isp7sp_get_mem_info,
	.get_gce_virt = isp7sp_get_gce_virt,
	.get_gce = isp7sp_get_gce,
	.put_gce = isp7sp_put_gce,
	.get_gce_token_virt = isp7sp_get_gce_token_virt,

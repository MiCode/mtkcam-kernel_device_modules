...
/* for isp8_2 */
#define V1_FD_IPN_640_480_COEF_SIZE_2 (10955 * MAE_BASE_ADDR_ALIGN)
#define V1_FD_IPN_640_480_CONFIG_SINGLE_SIZE_2 (7937 * MAE_BASE_ADDR_ALIGN)
#define V1_FD_IPN_640_480_CONFIG_SIZE_2 (3 * V1_FD_IPN_640_480_CONFIG_SINGLE_SIZE_2)
#define V1_FD_IPN_640_480_COEF_PAT_OFFSET_2   0
#define V1_FD_IPN_640_480_CONFIG_PAT_OFFSET_2 0

#define V1_FD_IPN_480_360_COEF_SIZE_2 (10947 * MAE_BASE_ADDR_ALIGN)
#define V1_FD_IPN_480_360_CONFIG_SINGLE_SIZE_2 (6676 * MAE_BASE_ADDR_ALIGN)
#define V1_FD_IPN_480_360_CONFIG_SIZE_2 (3 * V1_FD_IPN_480_360_CONFIG_SINGLE_SIZE_2)
#define V1_FD_IPN_480_360_COEF_PAT_OFFSET_2 \
		(V1_FD_IPN_640_480_COEF_PAT_OFFSET_2 + V1_FD_IPN_640_480_COEF_SIZE_2)
#define V1_FD_IPN_480_360_CONFIG_PAT_OFFSET_2 \
		(V1_FD_IPN_640_480_CONFIG_PAT_OFFSET_2 + V1_FD_IPN_640_480_CONFIG_SIZE_2)

#define V1_FD_IPN_240_180_COEF_SIZE_2 (10947 * MAE_BASE_ADDR_ALIGN)
#define V1_FD_IPN_240_180_CONFIG_SINGLE_SIZE_2 (5942 * MAE_BASE_ADDR_ALIGN)
#define V1_FD_IPN_240_180_CONFIG_SIZE_2 (3 * V1_FD_IPN_240_180_CONFIG_SINGLE_SIZE_2)
#define V1_FD_IPN_240_180_COEF_PAT_OFFSET_2 \
		(V1_FD_IPN_480_360_COEF_PAT_OFFSET_2 + V1_FD_IPN_480_360_COEF_SIZE_2)
#define V1_FD_IPN_240_180_CONFIG_PAT_OFFSET_2 \
		(V1_FD_IPN_480_360_CONFIG_PAT_OFFSET_2 + V1_FD_IPN_480_360_CONFIG_SIZE_2)

#define V1_FD_IPN_120_90_COEF_SIZE_2 (10939 * MAE_BASE_ADDR_ALIGN)
#define V1_FD_IPN_120_90_CONFIG_SINGLE_SIZE_2 (4827 * MAE_BASE_ADDR_ALIGN)
#define V1_FD_IPN_120_90_CONFIG_SIZE_2 (3 * V1_FD_IPN_120_90_CONFIG_SINGLE_SIZE_2)
#define V1_FD_IPN_120_90_COEF_PAT_OFFSET_2 \
		(V1_FD_IPN_240_180_COEF_PAT_OFFSET_2 + V1_FD_IPN_240_180_COEF_SIZE_2)
#define V1_FD_IPN_120_90_CONFIG_PAT_OFFSET_2 \
		(V1_FD_IPN_240_180_CONFIG_PAT_OFFSET_2 + V1_FD_IPN_240_180_CONFIG_SIZE_2)

#define V1_FD_FPN_480_360_COEF_SIZE_2 (59130 * MAE_BASE_ADDR_ALIGN)
#define V1_FD_FPN_480_360_CONFIG_SIZE_2 (8182 * MAE_BASE_ADDR_ALIGN)

#define V1_FLD_FAC_112_112_COEF_SIZE_2 (25411 * MAE_BASE_ADDR_ALIGN)
#define V1_FLD_FAC_112_112_CONFIG_SIZE_2 (4412 * MAE_BASE_ADDR_ALIGN)

...
void pda_mmqos_bw_set(struct PDA_HW_Register_Group *PDA_HW_Register)
{
	...
	// -------------------------- parameter estimate ------------------------
	Inter_Frame_Size_Width = PDA_HW_Register->PDA_CFG_0.Bits.PDA_WIDTH;
	Inter_Frame_Size_Height = PDA_HW_Register->PDA_CFG_0.Bits.PDA_HEIGHT;
	B_N = PDA_HW_Register->PDA_CFG_14.Bits.PDA_B_N;
